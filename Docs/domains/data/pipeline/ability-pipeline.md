...
Captura (Manual/Script)
  -> docs-references/semantic-ui-rips/*.md (Gramática Semantic Format)
...
| :--- | :--- |
| `docs-references/semantic-ui-rips/*.md` | **Fuente de Verdad Semántica**. No se modifican manualmente tras la captura. |
...
| `Project/src/core/engine/resolver.ts` | Consumidor final. Mapea la data del JSON a los contratos del Engine. |
