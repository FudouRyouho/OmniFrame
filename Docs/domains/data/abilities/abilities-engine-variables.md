...
El campo `upgradeBy` no se acopla directamente a modificadores crudos del dataset. En su lugar, utiliza identificadores del **Diccionario Semántico Canónico** definido en el tipado del proyecto (`src/lib/types/`). 
...
### Fuentes Operativas
- Lógica de maximización documentada en `docs-references/`.
- `Project/src/lib/types/ability.ts` (Contrato de tipos).
