...
-- See https://wiki.warframe.com/w/Category:Companion_Mods
-- https://wiki.warframe.com/w/Category:Warframe_Mods
-- https://wiki.warframe.com/w/Category:Primary_Mods
-- https://wiki.warframe.com/w/Category:Pistol_Mods
-- https://wiki.warframe.com/w/Category:Melee_Mods
-- https://wiki.warframe.com/w/Category:Necramech_Mods
...
return {
	DefaultUpgrades = {
		...
		["/Lotus/Weapons/CrewShip/Laser/Blaster/BlasterInnateDamageRandomMod"] = {
			_IgnoreEntry = true,
			CodexSecret = true,
			Description = "|val|% <DT_PUNCTURE_COLOR> Puncture Damage",
		...
		["/Lotus/Weapons/Grineer/KuvaLich/Upgrades/InnateDamageRandomMod"] = {
			...
			IsDefaultUpgrade = true,
			Link = "Adversary System/Progenitor",
		...
		["/Lotus/Weapons/CrewShip/ShrapnelShotgun/ShrapnelShotgunInnateDamageRandomMod"] = {
			_IgnoreEntry = true,
			CodexSecret = true,
			Description = "|val|% <DT_SLASH_COLOR>Slash Damage",
		...
		["/Lotus/Weapons/CrewShip/Laser/Beam/RailJackBeamInnateDamageRandomMod"] = {
			_IgnoreEntry = true,
			CodexSecret = true,
			Description = "|val|% <DT_FIRE_COLOR> Heat Damage",
		...
		["/Lotus/Weapons/CrewShip/ElectricTether/ElectricTetherInnateDamageRandomMod"] = {
			_IgnoreEntry = true,
			CodexSecret = true,
			Description = "|val|% <DT_ELECTRICITY_COLOR>Electricity Damage",
		...
		["/Lotus/Weapons/CrewShip/Laser/Blaster/BlasterShotgunInnateDamageRandomMod"] = {
			_IgnoreEntry = true,
			CodexSecret = true,
			Description = "|val|% <DT_FREEZE_COLOR> Cold Damage",
	...
	Sets = {
		...
		["Hunter Set"] = {
			...
			Description = "+25% Companion Damage on enemies affected by <DT_SLASH_COLOR>.",
		...
		["Jugulus Set"] = {
			...
			Description = "Slam attacks manifest Tendrils to lash enemies within 3m dealing 25 <DT_PUNCTURE_COLOR>Puncture Damage. Cooldown: 12s",
		...
		["Saxum Set"] = {
			...
			Description = "Lifted enemies explode on death, dealing 10% Enemy Max Health as <DT_IMPACT_COLOR>Impact Damage in a 4m radius\r\nCooldown: 6s",
	...
	Mods = {
		...
		["Accelerated Isotope"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+60% <DT_RADIATION_COLOR>Radiation\r\n+40% Fire Rate",
		...
		["Acidic Spittle"] = {
			BaseDrain = 0,
			Description = "Every 5s spit acidic tar at an enemy within 30m, blinding them for 12s and dealing 120 <DT_CORROSIVE_COLOR>Corrosive Damage.",
		...
		["Aegis Gale"] = {
			...
			Icon = "AegisGale.jpg",
			Image = "AegisGaleMod.png",
			InternalName = "/Lotus/Powersuits/IronFrame/IronFrameEruptionAugmentCard",
			Introduced = "37",
			IsAbilityAugment = true,
			Link = "Aegis Gale",
			MaxRank = 3,
		...
		["Agility Drift"] = {
			BaseDrain = 4,
			Description = "Reduced damage by 12% while airborne\r\n-6% Enemy Accuracy when targeting Warframe",
		...
		["Amalgam Argonak Metal Auger"] = {
			...
			Incompatible = { "Metal Auger", "Flawed Metal Auger" },
		...
		["Amalgam Barrel Diffusion"] = {
			...
			Incompatible = { "Barrel Diffusion", "Flawed Barrel Diffusion", "Galvanized Diffusion" },
			IncompatibilityTags = { "SENTINEL_WEAPON", "POWER_WEAPON" },
		...
		["Amalgam Daikyu Target Acquired"] = {
			BaseDrain = 10,
			Class = "Amalgam",
			Description = "+75% to Headshot Multiplier\r\n+3% Life Steal on Nikanas<LINE_SEPARATOR>60% chance to pickup used arrows.",
		...
		["Amalgam Furax Body Count"] = {
			BaseDrain = 6,
			Class = "Amalgam",
			Description = "+15s Combo Duration\r\n+45% Fire Rate for Secondary Weapons<LINE_SEPARATOR>Melee kills <DT_EXPLOSION_COLOR>Blast and stagger enemies in 15m",
		...
		["Amalgam Ripkas True Steel"] = {
			BaseDrain = 6,
			Class = "Amalgam",
			Description = "+187% Critical Chance (x2 for Heavy Attacks)\r\n+20% Reload Speed on Shotguns<LINE_SEPARATOR>+100% Gore Chance",
			Image = "AmalgamRipkasTrueSteelMod.png",
			Incompatible = { "True Steel", "Galvanized Steel", "Sacrificial Steel", "Flawed True Steel" },
			IncompatibilityTags = { "SENTINEL_WEAPON", "POWER_WEAPON" },
		...
		["Amalgam Serration"] = {
			...
			Incompatible = { "Serration", "Higasa Serration", "Flawed Serration", "Spectral Serration" },
			IncompatibilityTags = { "SENTINEL_WEAPON", "POWER_WEAPON" },
		...
		["Amanata Pressure"] = {
			...
			Icon = "AmanataPressure.jpg",
			Image = "AmanataPressureMod.png",
			Incompatible = { "Pressure Point", "Flawed Pressure Point", "Primed Pressure Point", "Sacrificial Pressure" },
			InternalName = "/Lotus/Weapons/Tenno/Melee/Polearms/Naginata/ShrineMaidenNaginataAugment",
			Introduced = "37",
			IsWeaponAugment = true,
			Link = "Amanata Pressure",
			MaxRank = 5,
		...
		["Ammo Chain"] = {
			...
			Incompatible = { "Primed Ammo Chain" },
		...
		["Anti-Flak Plating"] = {
			BaseDrain = 4,
			Conclave = true,
			Description = "+20 <DT_EXPLOSION_COLOR>Blast Resistance\r\n-10% Mobility",
		...
		["Anti-V"] = {
			...
			Icon = "Anti-V.png",
			Image = "AntiVMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Immortal/AntivirusSevenMod",
			Introduced = "38.5",
			Link = "Anti-V",
			MaxRank = 3,
			Name = "Anti-V",
		...
		["Archon Continuity"] = {
			BaseDrain = 6,
			Class = "Archon",
			Description = "+55% Ability Duration\r\nAbilities that inflict a <DT_POISON_COLOR>Toxin status effect will also apply a <DT_CORROSIVE_COLOR>Corrosive status effect.",
		...
		["Archon Flow"] = {
			BaseDrain = 6,
			Class = "Archon",
			Description = "+185% Energy Max\r\nEnemies killed by <DT_FREEZE_COLOR>Cold Abilities have 10% chance to drop an Energy Orb. Cooldown: 10s",
		...
		["Archon Stretch"] = {
			BaseDrain = 6,
			Class = "Archon",
			Description = "+45% Ability Range\r\nAbilities that deal <DT_ELECTRICITY_COLOR>Electricity Damage restore +2 Energy/s over 5s.",
		...
		["Assassin Posture"] = {
			...
			Icon = "AssassinPosture.jpg",
			Image = "AssassinPostureMod.png",
			InternalName = "/Lotus/Types/Friendly/Pets/BeastWeapons/Stances/BeastVIPStance",
			Introduced = "37",
			Link = "Assassin Posture",
			MaxRank = 3,
		...
		Assimilate = {
			BaseDrain = 6,
			Description = "Absorb Augment: Nyx can use weapons during Absorb and its duration is infinite, but it consumes 6.5 <ENERGY> Energy/s and its area of effect is halved.",
		...
		["Astral Bond"] = {
			BaseDrain = 2,
			Description = "Damage dealt by Operator or Drifter grants 60% damage and 30% <DT_RADIANT_COLOR>Void Damage to your Companion's attacks for 10s. Companion Void Damage adds +30% Amp and Energy Efficiency to Operator or Drifter for 5s.",
		...
		["Balanced Posture"] = {
			...
			Icon = "BalancedPosture.png",
			Image = "BalancedPostureMod.png",
			InternalName = "/Lotus/Types/Friendly/Pets/BeastWeapons/Stances/BeastNeutralStance",
			Introduced = "37",
			Link = "Balanced Posture",
			MaxRank = 3,
		...
		["Bane of Orokin"] = {
			...
			Image = "BaneofOrokinMod.png",
			Incompatible = { "Primed Bane of Orokin" },
		...
		["Bane of Infested"] = {
			...
			Incompatible = { "Primed Bane of Infested", "Flawed Bane of Infested" },
		...
		["Bane of The Murmur"] = {
			...
			Incompatible = { "Primed Bane of The Murmur" },
		...
		["Barrel Diffusion"] = {
			...
			Incompatible = { "Flawed Barrel Diffusion", "Amalgam Barrel Diffusion", "Galvanized Diffusion" },
		...
		["Bell Ringer"] = {
			...
			Icon = "BellRinger.jpg",
			Image = "BellRingerMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/BeastKnockdownWeaponMod",
			Introduced = "37",
			Link = "Bell Ringer",
			MaxRank = 3,
			Name = "Bell Ringer",
		...
		["Berserker Fury"] = {
			...
			Incompatible = { "Flawed Berserker Fury", "Fury", "Flawed Fury", "Primed Fury" },
		...
		["Biotic Rounds"] = {
			...
			Icon = "BioticRounds.png",
			Image = "BioticRoundsMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Nightwave/NightwaveTC2024AK47AugmentMod",
			Introduced = "38.0.8",
			IsExilus = false,
			IsFlawed = false,
			Link = "Biotic Rounds",
		...
		["Blade Storm"] = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "Stance: Project fierce Shadow Clones of Ash upon groups of distant enemies. Join the fray using Teleport. The Shadow Clones can be upgraded with mods.",
			Icon = "BladeStormModx256.png",
			Image = "BladeStormStanceMod.png",
			InternalName = "/Lotus/Weapons/Tenno/Melee/MeleeTrees/NinjaStormMeleeTree",
			Introduced = "38.5",
			Link = "Blade Storm (Stance)",
			MaxRank = 3,
			Name = "Blade Storm",
			NotUpgradable = true,
			Polarity = "Zenurik",
		...
		Bloodthirst = {
			...
			Icon = "Bloodthirst.jpg",
			Image = "BloodthirstMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/BeastDrainingBiteMod",
			Introduced = "37",
			Link = "Bloodthirst",
			MaxRank = 3,
			Name = "Bloodthirst",
		...
		Blunderbuss = {
			...
			Incompatible = { "Flawed Blunderbuss", "Critical Deceleration" },
		...
		Botanist = {
			BaseDrain = 4,
			Description = "Oxylus Sentinel will automatically pick any plants within 50m over 2.0s.",
		...
		["Brute Conditioning"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+385% Melee Damage\r\nConvert all base Physical Damage to <DT_IMPACT_COLOR>Impact Damage",
			Icon = "BruteConditioning.png",
			Image = "BruteConditioningMod.png",
			Incompatible = { "Disabling Conditioning", "Precision Conditioning" },
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/BeastBruteConditioningMod",
			Introduced = "37",
			Link = "Brute Conditioning",
			MaxRank = 10,
		...
		["Burning Claws"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+330% <DT_FIRE_COLOR>Heat\r\n+330% Status Chance\r\nConverts all elemental damage from these claws to <DT_FIRE_COLOR>Heat damage",
			Icon = "BurningClaws.jpg",
			Image = "BurningClawsMod.png",
			Incompatible = { "Chilling Claws", "Sepsis Claws", "Shocking Claws" },
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/KubrowHeatConversionMod",
			Introduced = "37",
			Link = "Burning Claws",
			MaxRank = 10,
			Name = "Burning Claws",
		...
		["Burning Hate"] = {
			...
			Icon = "BurningHate.jpg",
			Image = "BurningHateMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Melee/Event/Nightwave/NightwaveStalkerScytheAugmentMod",
			Introduced = "36.1.5",
			IsWeaponAugment = true,
			Link = "Burning Hate",
			MaxRank = 5,
		...
		["ByteRyte"] = {
			...
			Icon = "ByteRyte.png",
			Image = "ByteRyteMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Immortal/AntivirusOneMod",
			Introduced = "38.5",
			Link = "ByteRyte",
			MaxRank = 3,
			Name = "ByteRyte",
		...
		["Cataclysmic Gate"] = {
			...
			Icon = "CataclysmicGate.jpg",
			Image = "CataclysmicGateMod.png",
			InternalName = "/Lotus/Powersuits/Wisp/WispSunAugmentCard",
			Introduced = "38.5",
			IsAbilityAugment = true,
			Link = "Cataclysmic Gate",
			MaxRank = 3,
		...
		["Charged Bullets"] = {
			BaseDrain = 4,
			Description = "+60% <DT_ELECTRICITY_COLOR>Electricity\r\n+60% Status Chance",
		...
		["Chilling Claws"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+330% <DT_FREEZE_COLOR>Cold\r\n+330% Status Chance\r\nConverts all elemental damage from these claws to <DT_FREEZE_COLOR>Cold damage",
			Icon = "ChillingClaws.jpg",
			Image = "ChillingClawsMod.png",
			Incompatible = { "Burning Claws", "Sepsis Claws", "Shocking Claws" },
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/KubrowColdConversionMod",
			Introduced = "37",
			Link = "Chilling Claws",
			MaxRank = 10,
			Name = "Chilling Claws",
		...
		["Chilling Grasp"] = {
			...
			Incompatible = { "Flawed Chilling Grasp", "Primed Chilling Grasp" },
		...
		["Chilling Reload"] = {
			BaseDrain = 2,
			Description = "+60% <DT_FREEZE_COLOR>Cold\r\n+40% Reload Speed",
		...
		["Cleanse Corpus"] = {
			...
			Incompatible = { "Flawed Cleanse Corpus", "Primed Cleanse Corpus" },
		...
		["Cleanse Orokin"] = {
			BaseDrain = 4,
			Description = "x1.3 Damage to Orokin",
			Image = "CleanseOrokinMod.png",
			Incompatible = { "Primed Cleanse Orokin" },
		...
		["Cleanse Grineer"] = {
			...
			Incompatible = { "Flawed Cleanse Grineer", "Primed Cleanse Grineer" },
		...
		["Cleanse Infested"] = {
			...
			Incompatible = { "Flawed Cleanse Infested", "Primed Cleanse Infested" },
		...
		["Cleanse The Murmur"] = {
			...
			Incompatible = { "Primed Cleanse The Murmur" },
		...
		["Coaction Drift"] = {
			BaseDrain = 4,
			Description = "Squad benefits +15% more from Auras\r\nYou benefit an additional +15% from Auras",
		...
		["Coil Recharge"] = {
			...
			Icon = "CoilRecharge.jpg",
			Image = "CoilRechargeMod.png",
			InternalName = "/Lotus/Powersuits/Gyre/GyreSphereAugmentCard",
			Introduced = "37",
			IsAbilityAugment = true,
			Link = "Coil Recharge",
			MaxRank = 3,
		...
		["Computer Cop"] = {
			...
			Icon = "ComputerCop.png",
			Image = "ComputerCopMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Immortal/AntivirusEightMod",
			Introduced = "38.5",
			Link = "Computer Cop",
			MaxRank = 3,
			Name = "Computer Cop",
		...
		["Concussion Rounds"] = {
			...
			Incompatible = { "Flawed Concussion Rounds" },
		...
		["Conductive Sphere"] = {
			...
			Icon = "ConductiveSphere.jpg",
			Image = "ConductiveSphereMod.png",
			InternalName = "/Lotus/Powersuits/Gyre/GyrePulseAugmentCard",
			Introduced = "38.5",
			IsAbilityAugment = true,
			Link = "Conductive Sphere",
			MaxRank = 3,
		...
		["Contagion Cloud"] = {
			BaseDrain = 6,
			Description = "Toxic Lash Augment: Create 5m toxic clouds, dealing 300 <DT_POISON_COLOR>Toxin Damage/s for 12s with every kill. Damage is twice as strong for Melee kills.",
		...
		["Contagious Spread"] = {
			...
			Incompatible = { "Flawed Contagious Spread" },
		...
		["Contamination Casing"] = {
			BaseDrain = 4,
			Description = "+60% <DT_POISON_COLOR>Toxin\r\n+60% Status Chance",
		...
		["Coolant Leak"] = {
			BaseDrain = 2,
			Description = "Unleashes a 10m radial blast of <DT_FREEZE_COLOR>Cold when multiple enemies are nearby. Add 3 stacks. 10s cooldown.",
		...
		["Corroding Barrage"] = {
			BaseDrain = 6,
			Description = "Tempest Barrage Augment: Each projectile has a 100% chance of inflicting a <DT_CORROSIVE_COLOR>Corrosive Status Effect. Tempest Barrage gains 100% Ability Strength.",
		...
		Counterbalance = {
			...
			Incompatible = { "Primed Counterbalance" },
		...
		["Critical Deceleration"] = {
			...
			Incompatible = { "Blunderbuss", "Flawed Blunderbuss" },
		...
		["Critical Delay"] = {
			...
			Incompatible = { "Point Strike", "Flawed Point Strike" },
		...
		["Cryo Rounds"] = {
			...
			Incompatible = { "Flawed Cryo Rounds", "Primed Cryo Rounds" },
		...
		["Cull the Weak"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+60% Melee Damage per Status Type affecting the target\r\nNon-Critical hits deal +240% damage",
			Icon = "CulltheWeak.jpg",
			Image = "CulltheWeakMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/BeastCullTheWeakMod",
			Introduced = "37",
			Link = "Cull the Weak",
			MaxRank = 5,
			Name = "Cull the Weak",
		...
		["Da-Ren"] = {
			...
			Class = "Vazarin",
			Conclave = false,
			Description = "+300 Operator Shields\r\n+30 bonus for each <UNAIRU_CLEAN>Unairu School Mod",
			Icon = "Da-Ren.jpg",
			Image = "Da-RenMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/ShieldSchool",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Da-Ren",
			MaxRank = 5,
		...
		["Diamond Skin"] = {
			BaseDrain = 4,
			Description = "+45% <DT_RADIATION_COLOR>Radiation Resistance",
			Image = "DiamondSkinMod.png",
			Incompatible = { "Flawed Diamond Skin" },
		...
		["Disabling Conditioning"] = {
			...
			Icon = "DisablingConditioning.jpg",
			Image = "DisablingConditioningMod.png",
			Incompatible = { "Brute Conditioning", "Precision Conditioning" },
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/BeastDisablingConditioningMod",
			Introduced = "37",
			Link = "Disabling Conditioning",
			MaxRank = 10,
		...
		["Draining Bite"] = {
			BaseDrain = 0,
			Description = "Vasca Kavat inflicts 5 stacks of <DT_SLASH_COLOR>Slash at 150% of its melee damage and restores 10% Health to itself.",
		...
		["Dreadful Killshot"] = {
			...
			Icon = "DreadfulKillshot.jpg",
			Image = "DreadfulKillshotMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Event/Nightwave/NightwaveBasmuAugmentMod",
			Introduced = "40.0.4",
			Link = "Dreadful Killshot",
			MaxRank = 5,
		...
		["Drive-Duster"] = {
			...
			Icon = "Drive-Duster.png",
			Image = "DriveDusterMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Immortal/AntivirusFiveMod",
			Introduced = "38.5",
			Link = "Drive-Duster",
			MaxRank = 3,
			Name = "Drive-Duster",
		...
		["Primed Venomous Clip"] = {
			...
			Incompatible = { "Venomous Clip" },
			InternalName = "/Lotus/Upgrades/Mods/Archwing/Rifle/Expert/ArchwingWeaponToxinDamageModExpert",
			Introduced = "41.0.5",
		...
		["Empazu-Shol"] = {
			...
			Class = "Zenurik",
			Conclave = false,
			Description = "+12% Tauron Strike Initial Charge.\r\n+2% bonus for each Mod from a unique School",
			Icon = "Empazu-Shol.jpg",
			Image = "Empazu-SholMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/UltimateInitialChargeSchools",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Empazu-Shol",
			MaxRank = 5,
		...
		["Elusive Posture"] = {
			...
			Icon = "ElusivePosture.jpg",
			Image = "ElusivePostureMod.png",
			InternalName = "/Lotus/Types/Friendly/Pets/BeastWeapons/Stances/BeastPacifistStance",
			Introduced = "37",
			Link = "Elusive Posture",
			MaxRank = 3,
		...
		["Entropy Detonation"] = {
			BaseDrain = 4,
			Description = "Lethal ground attacks cause enemies to explode dealing +1,000\r\n(+20% Enemy Max Health) <DT_EXPLOSION_COLOR>Blast Damage\r\nin a +10m radius.\r\n+1 'Entropy'",
		...
		["Esti Vel-Ikha"] = {
			...
			Icon = "EstiVel-Ikha.jpg",
			Image = "EstiVel-IkhaMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/DashDistanceSchools",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Esti Vel-Ikha",
			MaxRank = 5,
		...
		["Evir-Ti"] = {
			...
			Icon = "Evir-Ti.jpg",
			Image = "Evir-TiMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/JumpHeight",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Evir-Ti",
			MaxRank = 3,
		...
		["Expel Corpus"] = {
			...
			Incompatible = { "Flawed Expel Corpus", "Primed Expel Corpus" },
		...
		["Expel Orokin"] = {
			BaseDrain = 4,
			Description = "x1.3 Damage to Orokin",
			Image = "ExpelOrokinMod.png",
			Incompatible = { "Primed Expel Orokin" },
		...
		["Expel Grineer"] = {
			...
			Incompatible = { "Flawed Expel Grineer", "Primed Expel Grineer" },
		...
		["Expel Infested"] = {
			...
			Incompatible = { "Flawed Expel Infested", "Primed Expel Infested" },
		...
		["Expel The Murmur"] = {
			...
			Incompatible = { "Primed Expel The Murmur" },
		...
		["Razorwing"] = {
			BaseDrain = 0,
			Description = "Stance: Shrink down and take flight, while razorflies attack nearby enemies and amplify the damage they take.",
			Image = "RazorwingMod.png",
			InternalName = "/Lotus/Animations/FlightSuit/TestMeleeAttacks/FairyMeleeTree",
			Introduced = "29.10",
			CodexSecret = false,
			Link = "Razorwing (Stance)",
			MaxRank = 3,
			Name = "Razorwing",
			Icon = "RazorwingModx256.png",
			NotUpgradable = true,
			Polarity = "Zenurik",
			Rarity = "Common",
			Tradable = false,
		...
		["Fireball Frenzy"] = {
			BaseDrain = 6,
			Description = "Fireball Augment: Hold to cast will grant all allies within 15m an additional 100% <DT_FIRE_COLOR>Heat Damage to their attacks for 40s.",
		...
		["Flame Gland"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+60% <DT_FIRE_COLOR>Heat\r\n+60% Status Chance",
			Icon = "FlameGland.png",
		...
		["Flame Repellent"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+60% <DT_FIRE_COLOR>Heat Resistance",
			Icon = "FlameRepellent.png",
			Image = "FlameRepellentMod.png",
			Incompatible = { "Flawed Flame Repellent" },
		...
		["Flawed Antitoxin"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% <DT_POISON_COLOR>Toxin Resistance",
			Icon = "Antitoxin.png",
			Image = "FlawedAntitoxinMod.png",
			Incompatible = { "Antitoxin" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Beginner/AvatarDamageResistancePoisonBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Antitoxin (Mod)",
			MaxRank = 3,
			Name = "Flawed Antitoxin",
			Polarity = "Vazarin",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Bane of Infested"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "x1.1 Damage to Infested",
			Icon = "BaneofInfested.png",
			Image = "FlawedBaneofInfestedMod.png",
			Incompatible = { "Bane of Infested", "Primed Bane of Infested" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponFactionDamageInfestedBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Bane of Infested",
			MaxRank = 3,
			Name = "Flawed Bane of Infested",
			Polarity = "Madurai",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Barrel Diffusion"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+40% Multishot",
			Icon = "BarrelDiffusion.png",
			Image = "FlawedBarrelDiffusionMod.png",
			Incompatible = { "Barrel Diffusion", "Amalgam Barrel Diffusion", "Galvanized Diffusion" },
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Beginner/WeaponFireIterationsModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Barrel Diffusion",
			MaxRank = 3,
			Name = "Flawed Barrel Diffusion",
			Polarity = "Madurai",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Berserker Fury"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "On Melee Kill:\r\n+23.3% Attack Speed for 10s. Stacks up to 2x.",
			Icon = "Berserker Fury.png",
			Image = "FlawedBerserkerFuryMod.png",
			Incompatible = { "Berserker Fury", "Fury", "Primed Fury", "Flawed Fury" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/WeaponCritFireRateBonusModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Berserker Fury",
			MaxRank = 3,
			Name = "Flawed Berserker Fury",
			Polarity = "Madurai",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Blunderbuss"] = {
			...
			Icon = "Blunderbuss.png",
			Image = "FlawedBlunderbussMod.png",
			Incompatible = { "Blunderbuss", "Critical Deceleration" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponCritChanceModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Blunderbuss",
			MaxRank = 3,
			Name = "Flawed Blunderbuss",
			Polarity = "Madurai",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Charged Shell"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+40% <DT_ELECTRICITY_COLOR>Electricity",
			Icon = "ChargedShell.png",
		...
		["Flawed Chilling Grasp"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+40% <DT_FREEZE_COLOR>Cold",
			Icon = "ChillingGrasp.png",
			Image = "FlawedChillingGraspMod.png",
			Incompatible = { "Chilling Grasp", "Primed Chilling Grasp" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponColdDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Chilling Grasp",
			MaxRank = 3,
			Name = "Flawed Chilling Grasp",
			Polarity = "Vazarin",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Cleanse Corpus"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "x1.12 Damage to Corpus",
			Icon = "CleanseCorpus.png",
			Image = "FlawedCleanseCorpusMod.png",
			Incompatible = { "Cleanse Corpus", "Primed Cleanse Corpus" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponFactionDamageCorpusBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Cleanse Corpus",
			MaxRank = 3,
			Name = "Flawed Cleanse Corpus",
			Polarity = "Madurai",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Cleanse Grineer"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "x1.12 Damage to Grineer",
			Icon = "CleanseGrineer.png",
			Image = "FlawedCleanseGrineerMod.png",
			Incompatible = { "Cleanse Grineer", "Primed Cleanse Grineer" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponFactionDamageGrineerBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Cleanse Grineer",
			MaxRank = 3,
			Name = "Flawed Cleanse Grineer",
			Polarity = "Madurai",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Cleanse Infested"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "x1.12 Damage to Infested",
			Icon = "CleanseInfested.png",
			Image = "FlawedCleanseInfestedMod.png",
			Incompatible = { "Cleanse Infested", "Primed Cleanse Infested" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponFactionDamageInfestedBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Cleanse Infested",
			MaxRank = 3,
			Name = "Flawed Cleanse Infested",
			Polarity = "Madurai",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Concussion Rounds"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+32% <DT_IMPACT_COLOR>Impact",
			Icon = "ConcussionRounds.png",
			Image = "FlawedConcussionRoundsMod.png",
			Incompatible = { "Concussion Rounds" },
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Beginner/WeaponImpactDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Concussion Rounds",
			MaxRank = 3,
			Name = "Flawed Concussion Rounds",
			Polarity = "Naramon",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Contagious Spread"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+40% <DT_POISON_COLOR>Toxin",
			Icon = "ContagiousSpread.png",
			Image = "FlawedContagiousSpreadMod.png",
			Incompatible = { "Contagious Spread" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponToxinDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Contagious Spread",
			MaxRank = 3,
			Name = "Flawed Contagious Spread",
			Polarity = "Naramon",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Cryo Rounds"] = {
			...
			Description = "+40% <DT_FREEZE_COLOR>Cold",
			Icon = "CryoRounds.png",
			Image = "FlawedCryoRoundsMod.png",
			Incompatible = { "Cryo Rounds", "Primed Cryo Rounds" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponFreezeDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Cryo Rounds",
			MaxRank = 3,
			Name = "Flawed Cryo Rounds",
			Polarity = "Vazarin",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Deep Freeze"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% <DT_FREEZE_COLOR>Cold",
			Icon = "DeepFreeze.png",
		...
		["Flawed Diamond Skin"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% <DT_RADIATION_COLOR>Radiation Resistance",
			Icon = "DiamondSkin.png",
			Image = "FlawedDiamondSkinMod.png",
			Incompatible = { "Diamond Skin" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Beginner/AvatarDamageResistanceLaserBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Diamond Skin",
			MaxRank = 3,
			Name = "Flawed Diamond Skin",
			Polarity = "Vazarin",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Disruptor"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+12% <DT_IMPACT_COLOR>Impact",
			Icon = "Disruptor.png",
			Image = "FlawedDisruptorMod.png",
			Incompatible = { "Disruptor" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponImpactDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Disruptor",
			MaxRank = 3,
			Name = "Flawed Disruptor",
			Polarity = "Naramon",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Expel Infested"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "x1.1 Damage to Infested",
			Icon = "ExpelInfested.png",
			Image = "FlawedExpelInfestedMod.png",
			Incompatible = { "Expel Infested", "Primed Expel Infested" },
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Beginner/WeaponPistolFactionDamageInfestedBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Expel Infested",
			MaxRank = 3,
			Name = "Flawed Expel Infested",
			Polarity = "Madurai",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Flame Repellent"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% <DT_FIRE_COLOR>Heat Resistance",
			Icon = "FlameRepellent.png",
			Image = "FlawedFlameRepellentMod.png",
			Incompatible = { "Flame Repellent" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Beginner/AvatarDamageResistanceFireBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Flame Repellent",
			MaxRank = 3,
			Name = "Flawed Flame Repellent",
			Polarity = "Vazarin",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Flechette"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+12% <DT_PUNCTURE_COLOR>Puncture",
			Icon = "Flechette.png",
			Image = "FlawedFlechetteMod.png",
			Incompatible = { "Flechette" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponArmorPiercingDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Flechette",
			MaxRank = 3,
			Name = "Flawed Flechette",
			Polarity = "Naramon",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Fury"] = {
			...
			Incompatible = { "Berserker Fury", "Flawed Berserker Fury", "Fury", "Primed Fury" },
		...
		["Flawed Gunslinger"] = {
			...
			Icon = "Gunslinger.png",
			Image = "FlawedGunslingerMod.png",
			Incompatible = { "Gunslinger" },
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Beginner/WeaponFireRateModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Gunslinger",
			MaxRank = 3,
			Name = "Flawed Gunslinger",
			Polarity = "Madurai",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Heated Charge"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+40% <DT_FIRE_COLOR>Heat",
		...
		["Flawed Heavy Impact"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "Create 2m seismic shockwaves from heavy landings, dealing 200 Damage and knocking foes off their feet.",
			Icon = "HeavyImpact.png",
			Image = "FlawedHeavyImpactMod.png",
			Incompatible = { "Heavy Impact" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Beginner/AvatarFallingImpactModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Heavy Impact",
			MaxRank = 3,
			Name = "Flawed Heavy Impact",
			Polarity = "Naramon",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Heavy Trauma"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+60% <DT_IMPACT_COLOR>Impact",
			Icon = "HeavyTrauma.png",
			Image = "FlawedHeavyTraumaMod.png",
			Incompatible = { "Heavy Trauma", "Primed Heavy Trauma" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/WeaponImpactDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Heavy Trauma",
			MaxRank = 3,
			Name = "Flawed Heavy Trauma",
			Polarity = "Naramon",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Hell's Chamber"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+40% Multishot",
			Icon = "Hell'sChamber.png",
			Image = "FlawedHell'sChamberMod.png",
			Incompatible = { "Hell's Chamber", "Galvanized Hell" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponFireIterationsModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Hell's Chamber",
			MaxRank = 3,
			Name = "Flawed Hell's Chamber",
			Polarity = "Madurai",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Infected Clip"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+40% <DT_POISON_COLOR>Toxin",
			Icon = "InfectedClip.png",
			Image = "FlawedInfectedClipMod.png",
			Incompatible = { "Infected Clip" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponToxinDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Infected Clip",
			MaxRank = 3,
			Name = "Flawed Infected Clip",
			Polarity = "Naramon",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Intruder"] = {
			...
			Icon = "Intruder.png",
			Image = "FlawedIntruderMod.png",
			Incompatible = { "Intruder" },
			InternalName = "/Lotus/Upgrades/Mods/Parazon/Beginner/AvatarTimeLimitIncreaseModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Intruder",
			MaxRank = 3,
			Name = "Flawed Intruder",
			Polarity = "Universal",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Insulation"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% <DT_FREEZE_COLOR>Cold Resistance",
			Icon = "Insulation.png",
			Image = "FlawedInsulationMod.png",
			Incompatible = { "Insulation" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Beginner/AvatarDamageResistanceIceBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Insulation",
			MaxRank = 3,
			Name = "Flawed Insulation",
			Polarity = "Vazarin",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Jagged Edge"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+60% <DT_SLASH_COLOR>Slash",
			Icon = "JaggedEdge.png",
			Image = "FlawedJaggedEdgeMod.png",
			Incompatible = { "Jagged Edge" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/WeaponSlashDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Jagged Edge",
			MaxRank = 3,
			Name = "Flawed Jagged Edge",
			Polarity = "Naramon",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Lightning Rod"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% <DT_ELECTRICITY_COLOR>Electricity Resistance",
			Icon = "LightningRod.png",
			Image = "FlawedLightningRodMod.png",
			Incompatible = { "Lightning Rod" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Beginner/AvatarDamageResistanceElectricityBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Lightning Rod",
			MaxRank = 3,
			Name = "Flawed Lightning Rod",
			Polarity = "Vazarin",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Maglev"] = {
			BaseDrain = 6,
			CodexSecret = true,
			Description = "+20% Slide\r\n-20% Friction",
			Icon = "Maglev.png",
			Image = "FlawedMaglevMod.png",
			Incompatible = { "Maglev" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Beginner/AvatarSlideBoostModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Maglev",
			MaxRank = 3,
		...
		["Flawed Melee Prowess"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+60% Status Chance",
			Icon = "MeleeProwess.png",
			Image = "FlawedMeleeProwessMod.png",
			Incompatible = { "Melee Prowess" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/WeaponStunChanceModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Melee Prowess",
			MaxRank = 3,
			Name = "Flawed Melee Prowess",
			Polarity = "Vazarin",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Metal Auger"] = {
			BaseDrain = 6,
			CodexSecret = true,
			Description = "+1 Punch Through",
			Icon = "MetalAuger.png",
			Image = "FlawedMetalAugerMod.png",
			Incompatible = { "Metal Auger", "Amalgam Argonak Metal Auger" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponPunctureDepthModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Metal Auger",
			MaxRank = 3,
			Name = "Flawed Metal Auger",
			Polarity = "Naramon",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed No Return"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% <DT_PUNCTURE_COLOR>Puncture",
			Icon = "NoReturn.png",
			Image = "FlawedNoReturnMod.png",
			Incompatible = { "No Return" },
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Beginner/WeaponArmorPiercingDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "No Return",
			MaxRank = 3,
			Name = "Flawed No Return",
			Polarity = "Naramon",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Parry"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+48% chance to open enemies to Finisher Attacks after Warframe blocks Melee",
			Icon = "Parry.png",
			Image = "FlawedParryMod.png",
			Incompatible = { "Parry" },
			IncompatibilityTags = { "SENTINEL_WEAPON", "HOUND_WEAPON" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/AvatarParryMeleeModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Parry",
			MaxRank = 3,
		...
		["Flawed Piercing Hit"] = {
			...
			Image = "FlawedPiercingHitMod.png",
			Incompatible = { "Piercing Hit" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponArmorPiercingDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Piercing Hit",
			MaxRank = 3,
			Name = "Flawed Piercing Hit",
			Polarity = "Naramon",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Point Strike"] = {
			...
			Image = "FlawedPointStrikeMod.png",
			Incompatible = { "Point Strike", "Critical Delay" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponCritChanceModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Point Strike",
			MaxRank = 3,
			Name = "Flawed Point Strike",
			Polarity = "Madurai",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Power Throw"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+1.3 Punch Through\r\nOn Consecutive throw (Max stacks 3):\r\n+66.7% Throw Damage",
			Icon = "PowerThrow.png",
			Image = "FlawedPowerThrowMod.png",
			Incompatible = { "Power Throw" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/WeaponGlaivePowerthrowModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Power Throw",
			MaxRank = 3,
			Name = "Flawed Power Throw",
			Polarity = "Madurai",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Pressure Point"] = {
			...
			Incompatible = { "Pressure Point", "Primed Pressure Point", "Sacrificial Pressure", "Amanata Pressure" },
		...
		["Flawed Provoked"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+20% Damage during Bleedout",
			Icon = "Provoked.png",
			Image = "FlawedProvokedMod.png",
			Incompatible = { "Provoked" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Beginner/AvatarGroundFireDmgModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Provoked",
			MaxRank = 3,
			Name = "Flawed Provoked",
			Polarity = "Madurai",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Quick Thinking"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "Drains Energy to stop Lethal Damage with 80% Efficiency.",
			Icon = "QuickThinking.png",
			Image = "FlawedQuickThinkingMod.png",
			Incompatible = { "Quick Thinking" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Beginner/AvatarPowerToHealthOnDeathModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Quick Thinking",
			MaxRank = 3,
			Name = "Flawed Quick Thinking",
			Polarity = "Vazarin",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Ravage"] = {
			...
			Icon = "Ravage.png",
			Image = "FlawedRavageMod.png",
			Incompatible = { "Ravage", "Primed Ravage" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponCritDamageModBeginner",
			Introduced = "14",
			IsExilus = true,
			IsFlawed = true,
			Link = "Ravage",
		...
		["Flawed Razor Shot"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+30% <DT_SLASH_COLOR>Slash",
			Icon = "RazorShot.png",
			Image = "FlawedRazorShotMod.png",
			Incompatible = { "Razor Shot" },
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Beginner/WeaponSlashDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Razor Shot",
			MaxRank = 3,
			Name = "Flawed Razor Shot",
			Polarity = "Naramon",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Reflection"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+48% Damage taken is reflected when Blocking attacks while Channeling",
			Icon = "Reflection.png",
			Image = "FlawedReflectionMod.png",
			Incompatible = { "Reflection" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Beginner/AvatarParryReflectModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Reflection",
			MaxRank = 3,
			Name = "Flawed Reflection",
			Polarity = "Vazarin",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Reflex Coil"] = {
			...
			Icon = "ReflexCoil.png",
			Image = "FlawedReflexCoilMod.png",
			Incompatible = { "Reflex Coil", "Galvanized Reflex" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/WeaponMeleeChargeRateModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Reflex Coil",
			MaxRank = 3,
			Name = "Flawed Reflex Coil",
			Polarity = "Naramon",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Rifle Aptitude"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+60% Status Chance",
			Icon = "RifleAptitude.png",
			Image = "FlawedRifleAptitudeMod.png",
			Incompatible = { "Rifle Aptitude", "Galvanized Aptitude" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponStunChanceModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Rifle Aptitude",
			MaxRank = 3,
			Name = "Flawed Rifle Aptitude",
			Polarity = "Vazarin",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Rupture"] = {
			...
			Description = "+12% <DT_IMPACT_COLOR>Impact",
			Icon = "Rupture.png",
			Image = "FlawedRuptureMod.png",
			Incompatible = { "Rupture" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponImpactDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Rupture",
			MaxRank = 3,
		...
		["Flawed Sawtooth Clip"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+10% <DT_SLASH_COLOR>Slash",
			Icon = "SawtoothClip.png",
			Image = "FlawedSawtoothClipMod.png",
			Incompatible = { "Sawtooth Clip" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponSlashDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Sawtooth Clip",
			MaxRank = 3,
			Name = "Flawed Sawtooth Clip",
			Polarity = "Naramon",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Seeker"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+0.6 Punch Through",
			Icon = "Seeker.png",
			Image = "FlawedSeekerMod.png",
			Incompatible = { "Seeker" },
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Beginner/WeaponPunctureDepthModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Seeker (Mod)",
			MaxRank = 3,
		...
		["Flawed Seeking Force"] = {
			BaseDrain = 6,
			CodexSecret = true,
			Description = "+0.8 Punch Through",
			Icon = "SeekingForce.png",
			Image = "FlawedSeekingForceMod.png",
			Incompatible = { "Seeking Force" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponPunctureDepthModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Seeking Force",
			MaxRank = 3,
			Name = "Flawed Seeking Force",
			Polarity = "Naramon",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Shredder"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+12% <DT_SLASH_COLOR>Slash",
			Icon = "Shredder.png",
			Image = "FlawedShredderMod.png",
			Incompatible = { "Shredder" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponSlashDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Shredder",
			MaxRank = 3,
			Name = "Flawed Shredder",
			Polarity = "Naramon",
			Rarity = "Common",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Shotgun Savvy"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+12% Status Chance",
			Icon = "ShotgunSavvy.png",
			Image = "FlawedShotgunSavvyMod.png",
			Incompatible = { "Shotgun Savvy", "Galvanized Savvy" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Beginner/WeaponStunChanceModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Shotgun Savvy",
			MaxRank = 3,
			Name = "Flawed Shotgun Savvy",
			Polarity = "Vazarin",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Smite Corpus"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "x1.2 Damage to Corpus",
			Icon = "SmiteCorpus.png",
			Image = "FlawedSmiteCorpusMod.png",
			Incompatible = { "Smite Corpus", "Primed Smite Corpus" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/WeaponMeleeFactionDamageCorpusBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Smite Corpus",
			MaxRank = 3,
			Name = "Flawed Smite Corpus",
			Polarity = "Madurai",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Smite Infested"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "x1.2 Damage to Infested",
			Icon = "SmiteInfested.png",
			Image = "FlawedSmiteInfestedMod.png",
			Incompatible = { "Smite Infested", "Primed Smite Infested" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/WeaponMeleeFactionDamageInfestedBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Smite Infested",
			MaxRank = 3,
			Name = "Flawed Smite Infested",
			Polarity = "Madurai",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Split Chamber"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+20% Multishot",
			Icon = "SplitChamber.png",
			Image = "FlawedSplitChamberMod.png",
			Incompatible = { "Split Chamber", "Split Flights", "Galvanized Chamber" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponFireIterationsModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Split Chamber",
			MaxRank = 3,
			Name = "Flawed Split Chamber",
			Polarity = "Madurai",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Sundering Strike"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+60% <DT_PUNCTURE_COLOR>Puncture",
			Icon = "SunderingStrike.png",
			Image = "FlawedSunderingStrikeMod.png",
			Incompatible = { "Sundering Strike" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/WeaponArmorPiercingDamageMod",
			Introduced = "14",
			IsFlawed = true,
			Link = "Sundering Strike",
			MaxRank = 3,
			Name = "Flawed Sundering Strike",
			Polarity = "Naramon",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Sure Shot"] = {
			BaseDrain = 2,
			CodexSecret = true,
			Description = "+4% Status Chance",
			Icon = "SureShot.png",
			Image = "FlawedSureShotMod.png",
			Incompatible = { "Sure Shot", "Galvanized Shot" },
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Beginner/WeaponStunChanceModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Sure Shot",
			MaxRank = 3,
			Name = "Flawed Sure Shot",
			Polarity = "Vazarin",
			Rarity = "Uncommon",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed True Steel"] = {
			...
			Incompatible = { "True Steel", "Galvanized Steel", "Sacrificial Steel", "Amalgam Ripkas True Steel" },
		...
		["Flawed Vital Sense"] = {
			...
			Description = "+60% Critical Damage",
			Icon = "VitalSense.png",
			Image = "FlawedVitalSenseMod.png",
			Incompatible = { "Vital Sense" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Beginner/WeaponCritDamageModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Vital Sense",
			MaxRank = 3,
			Name = "Flawed Vital Sense",
			Polarity = "Madurai",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Flawed Whirlwind"] = {
			BaseDrain = 4,
			CodexSecret = true,
			Description = "+120% Projectile Speed",
			Icon = "Whirlwind.png",
			Image = "FlawedWhirlwindMod.png",
			Incompatible = { "Whirlwind" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Beginner/WeaponGlaiveSpeedModBeginner",
			Introduced = "14",
			IsFlawed = true,
			Link = "Whirlwind",
			MaxRank = 3,
			Name = "Flawed Whirlwind",
			Polarity = "Madurai",
			Rarity = "Rare",
			Tradable = false,
			Transmutable = false,
		...
		["Freeze Force"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Freeze Augment: Hold to cast will grant all allies within 15m an additional 100% <DT_FREEZE_COLOR>Cold Damage to their attacks for 40s.",
		...
		["Frenzied Posture"] = {
			...
			Icon = "FrenziedPosture.jpg",
			Image = "FrenziedPostureMod.png",
			InternalName = "/Lotus/Types/Friendly/Pets/BeastWeapons/Stances/BeastSpreadAttacksStance",
			Introduced = "37",
			Link = "Frenzied Posture",
			MaxRank = 3,
		...
		Fury = {
			...
			Icon = "Fury.png",
			Image = "FuryMod.png",
			Incompatible = { "Primed Fury", "Flawed Fury", "Berserker Fury", "Flawed Berserker Fury" },
		...
		["Fused Crucible"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Crucible Blast Augment: Becomes a channeled ability consuming 20 <ENERGY> Energy/s that ramps up. While active Chyrinka Pillars trigger chain reactions and their duration is frozen. Mobility is greatly reduced.",
			Icon = "FusedCrucible.jpg",
			Image = "FusedCrucibleMod.png",
			InternalName = "/Lotus/Powersuits/ConcreteFrame/ConcreteLaserAugmentCard",
			Introduced = "38.5",
			IsAbilityAugment = true,
			Link = "Fused Crucible",
			MaxRank = 3,
		...
		["Galvanized Aptitude"] = {
			...
			Incompatible = { "Rifle Aptitude", "Flawed Rifle Aptitude" },
		...
		["Galvanized Chamber"] = {
			...
			Incompatible = { "Split Chamber", "Flawed Split Chamber", "Split Flights" },
		...
		["Galvanized Diffusion"] = {
			...
			Incompatible = { "Barrel Diffusion", "Flawed Barrel Diffusion", "Amalgam Barrel Diffusion" },
		...
		["Galvanized Elementalist"] = {
			...
			Icon = "GalvanizedElementalist.jpg",
			Image = "GalvanizedElementalistMod.png",
			Incompatible = { "Melee Elementalist" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Expert/WeaponMeleeStatusChanceSPMod",
			Introduced = "37",
			Link = "Galvanized Elementalist",
			MaxRank = 10,
		...
		["Galvanized Hell"] = {
			...
			Incompatible = { "Hell's Chamber", "Flawed Hell's Chamber" },
		...
		["Galvanized Reflex"] = {
			...
			Icon = "GalvanizedReflex.jpg",
			Image = "GalvanizedReflexMod.png",
			Incompatible = { "Reflex Coil", "Flawed Reflex Coil" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Expert/WeaponHeavyAttackEfficiencySPMod",
			Introduced = "37",
			Link = "Galvanized Reflex",
			MaxRank = 10,
		...
		["Galvanized Savvy"] = {
			...
			Incompatible = { "Shotgun Savvy", "Flawed Shotgun Savvy" },
		...
		["Galvanized Shot"] = {
			...
			Incompatible = { "Sure Shot", "Flawed Sure Shot" },
		...
		["Galvanized Steel"] = {
			...
			Icon = "GalvanizedSteel.jpg",
			Image = "GalvanizedSteelMod.png",
			Incompatible = { "True Steel", "Sacrificial Steel", "Amalgam Ripkas True Steel", "Flawed True Steel" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Expert/WeaponCritChanceSPMod",
			Introduced = "37",
			Link = "Galvanized Steel",
			MaxRank = 10,
		...
		Gastro = {
			...
			Icon = "Gastro.jpg",
			Image = "GastroMod.png",
			InternalName = "/Lotus/Powersuits/Devourer/DevourerRegurgitateAugmentCard",
			Introduced = "37",
			IsAbilityAugment = true,
			Link = "Gastro",
			MaxRank = 3,
		...
		Gunslinger = {
			...
			Incompatible = { "Flawed Gunslinger" },
		...
		["Hard Engage"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "Engages enemies within 10m with melee attacks, dealing 90 <DT_IMPACT_COLOR>Impact Damage. Melee attacks are enhanced by Mods equipped in the Moa's weapon.",
			Icon = "HardEngage.png",
		...
		["Harrowing Spire"] = {
			BaseDrain = -2,
			CompatibilityTags = { "BAYONET" },
			CodexSecret = false,
			Description = "Relentless jabs and powerful sweeping lunges.",
			Icon = "HarrowingSpire.jpg",
			Image = "HarrowingSpireMod.png",
			InternalName = "/Lotus/Weapons/Tenno/Melee/MeleeTrees/BayonetCmbOneMeleeTree",
			Introduced = "41",
			Link = "Harrowing Spire",
			MaxRank = 3,
		...
		["Hayan-Dabor"] = {
			...
			Icon = "Hayan-Dabor.jpg",
			Image = "Hayan-DaborMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/Multishot",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Hayan-Dabor",
			MaxRank = 5,
		...
		["Heavy Impact"] = {
			...
			Incompatible = { "Flawed Heavy Impact" },
		...
		["Heavy Trauma"] = {
			...
			Incompatible = { "Flawed Heavy Trauma", "Primed Heavy Trauma" },
		...
		["Hell's Chamber"] = {
			...
			Incompatible = { "Flawed Hell's Chamber", "Galvanized Hell" },
		...
		["Higasa Serration"] = {
			...
			Icon = "HigasaSerration.jpg",
			Image = "HigasaSerrationMod.png",
			Incompatible = { "Serration", "Flawed Serration", "Amalgam Serration", "Spectral Serration" },
			InternalName = "/Lotus/Weapons/Tenno/LongGuns/Gunbrella/ShrineMaidenGunbrellaAugment",
			Introduced = "37",
			IsWeaponAugment = true,
			Link = "Higasa Serration",
			MaxRank = 5,
		...
		["Hok-Kaal"] = {
			...
			Icon = "Hok-Kaal.jpg",
			Image = "Hok-KaalMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/DamageWhileInvisible",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Hok-Kaal",
			MaxRank = 5,
		...
		["Hunter Command"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "Applying a <DT_SLASH_COLOR>Slash Status to an enemy causes the Companion to attack them for 6s.",
		...
		["Hunter Munitions"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+30% chance to apply <DT_SLASH_COLOR> on Critical",
		...
		["Ice Spring"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "+24.2% to Bullet Jump\r\n+24.2% Aim Glide/Wall Latch Duration\r\n+275% <DT_FREEZE_COLOR>Cold on Bullet Jump",
			Icon = "IceSpring.png",
		...
		["Ice Wave Impedance"] = {
			...
			CodexSecret = false,
			Conclave = true,
			Description = "Ice Wave Augment: Create a frozen trail for 12 seconds. Enemies that touch it are inflicted with <DT_FREEZE_COLOR>Cold Status every second.",
		...
		["Immunity Resistance"] = {
			...
			Icon = "ImmunityResistance.jpg",
			Image = "ImmunityResistanceMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/BeastWeakenedImmunityMod",
			Introduced = "37",
			Link = "Immunity Resistance",
			MaxRank = 3,
		...
		["Immuno Shield"] = {
			...
			Icon = "ImmunoShield.jpg",
			Image = "ImmunoShieldMod.png",
			InternalName = "/Lotus/Upgrades/Mods/DataSpike/Potency/GainAntivirusOnUseMod",
			Introduced = "38.5",
			Link = "Immuno Shield",
			MaxRank = 3,
			Name = "Immuno Shield",
		...
		["Infected Clip"] = {
			...
			Incompatible = { "Flawed Infected Clip" },
		...
		["Instant Secure"] = {
			...
			Icon = "InstantSecure.jpg",
			Image = "InstantSecureMod.png",
			InternalName = "/Lotus/Upgrades/Mods/DataSpike/Potency/GainAntivirusLargeOnSingleUseMod",
			Introduced = "38.5",
			Link = "Instant Secure",
			MaxRank = 3,
			Name = "Instant Secure",
		...
		Insulation = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+60% <DT_FREEZE_COLOR>Cold Resistance",
			Icon = "Insulation.png",
			Image = "InsulationMod.png",
			Incompatible = { "Flawed Insulation" },
		...
		["Iron Shrapnel"] = {
			...
			CodexSecret = false,
			Conclave = true,
			Description = "Iron Skin Augment: Recasting Iron Skin will cause it to detonate, dealing 100% of its remaining Health as <DT_PUNCTURE_COLOR>Puncture Damage, and knocking down enemies.",
		...
		["Irradiating Disarm"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Radial Disarm Augment: Enemies will be affected by <DT_RADIATION_COLOR>Radiation Status for 9s",
		...
		["Jade's Judgment"] = {
			...
			Icon = "Jade'sJudgment.jpg",
			Image = "Jade'sJudgmentMod.png",
			InternalName = "/Lotus/Powersuits/Choir/ChoirPoolAugmentCard",
			Introduced = "39",
			IsAbilityAugment = true,
			Link = "Jade's Judgment",
			MaxRank = 3,
		...
		["Jagged Edge"] = {
			...
			Incompatible = { "Flawed Jagged Edge" },
		...
		["Kaal-zidi"] = {
			...
			Class = "Unairu",
			Conclave = false,
			Description = "+30% Void Mode efficiency\r\n+5% Movement Speed in Void Mode for each <NARAMON_CLEAN>Naramon School Mod",
			Icon = "Kaal-zidi.jpg",
			Image = "Kaal-zidiMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/Ghostwalk",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Kaal-zidi",
			MaxRank = 5,
		...
		["Keep-Clean"] = {
			...
			Icon = "Keep-Clean.png",
			Image = "KeepCleanMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Immortal/AntivirusFourMod",
			Introduced = "38.5",
			Link = "Keep-Clean",
			MaxRank = 3,
			Name = "Keep-Clean",
		...
		Landslide = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "Stance: Bash enemies with an explosive sliding punch, repeat up to three times for a combo attack. Each hit in the three-punch combo increases the radius of the attack. Energy cost is reduced with each hit of Landslide. Install mods on the Landslide Fists to boost stats.",
			Icon = "LandslideModx256.png",
			Image = "LandslideStanceMod.png",
			InternalName = "/Lotus/Weapons/Tenno/Melee/MeleeTrees/AtlasPunchMeleeTree",
			Introduced = "38.5",
			Link = "Landslide (Stance)",
			MaxRank = 3,
			Name = "Landslide",
			NotUpgradable = true,
			Polarity = "Zenurik",
		...
		["Lashta-Vak"] = {
			...
			Icon = "Lashta-Vak.jpg",
			Image = "Lashta-VakMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/VoidSlingCrateBreaker",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Lashta-Vak",
			MaxRank = 5,
		...
		["Lasting Purity"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+60% Damage when Aiming\r\n+1 'Purity'",
		...
		["Leaded Gas"] = {
			...
			Icon = "LeadedGas.jpg",
			Image = "LeadedGasMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Nightwave/NightwaveLasSilencedPistolAugmentMod",
			Introduced = "38.0.8",
			IsExilus = false,
			IsFlawed = false,
			Link = "Leaded Gas",
		...
		["Lightning Dash"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "+24.2% to Bullet Jump\r\n+24.2% Aim Glide/Wall Latch Duration\r\n+275% <DT_ELECTRICITY_COLOR>Electricity on Bullet Jump",
		...
		["Lightning Rod"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+60% <DT_ELECTRICITY_COLOR>Electricity Resistance",
			Icon = "LightningRod.png",
			Image = "LightningRodMod.png",
			Incompatible = { "Flawed Lightning Rod" },
		...
		["Lingering Transmutation"] = {
			...
			Image = "LingeringTransmutationMod.png",
			InternalName = "/Lotus/Powersuits/Alchemist/AlchemistTransmuteAugmentCard",
			Introduced = "40",
			CodexSecret = false,
			IsAbilityAugment = true,
			Link = "Lingering Transmutation",
			MaxRank = 3,
			Name = "Lingering Transmutation",
			Icon = "LingeringTransmutation.jpg",
			Polarity = "Zenurik",
			Rarity = "Rare",
			Tradable = true,
			Transmutable = false,
		...
		["Lorun-Tash"] = {
			...
			Icon = "Lorun-Tash.jpg",
			Image = "Lorun-TashMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/AntiqueArmour",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Lorun-Tash",
			MaxRank = 3,
		...
		["Loyal Retriever"] = {
			...
			Icon = "LoyalRetriever.jpg",
			Image = "LoyalRetrieverMod.png",
			Incompatible = { "Prosperous Retriever", "Resourceful Retriever" },
			InternalName = "/Lotus/Types/Sentinels/SentinelPrecepts/BeastLoyalRetriever",
			Introduced = "37",
			Link = "Loyal Retriever",
			MaxRank = 5,
		...
		["Magnetic Capacity"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+60% <DT_MAGNETIC_COLOR>Magnetic\r\n+40% Magazine Capacity",
			Icon = "MagneticCapacity.jpg",
			Image = "MagneticCapacityMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Rifle/DualStat/MagneticClipRifleMod",
			Introduced = "38",
			Link = "Magnetic Capacity",
			MaxRank = 3,
		...
		["Magnetic Claws"] = {
			...
			Conclave = false,
			Description = "+60% <DT_MAGNETIC_COLOR>Magnetic\r\n+40% Status Duration",
			Icon = "MagneticClaws.jpg",
			Image = "MagneticClawsMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/DualStat/KubrowMagneticEventMeleeMod",
			Introduced = "38",
			Link = "Magnetic Claws",
			MaxRank = 3,
			Name = "Magnetic Claws",
		...
		["Magnetic Might"] = {
			...
			CodexSecret = true,
			Description = "+60% <DT_MAGNETIC_COLOR>Magnetic\r\n+40% Critical Damage",
			Icon = "MagneticMight.png",
			Image = "MagneticMightMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Pistol/DualStat/MagneticCritDamagePistolMod",
			Introduced = "38",
			CodexSecret = true,
			Link = "Magnetic Might",
			MaxRank = 3,
			...
			Transmutable = false,
			Type = "Pistol",
			UpgradeTypes = { "WEAPON_PERCENT_BASE_DAMAGE_ADDED", "WEAPON_CRIT_DAMAGE" }
		},
		["Magnetic Rush"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+60% <DT_MAGNETIC_COLOR>Magnetic\r\n+20% Attack Speed",
			Icon = "MagneticRush.jpg",
			Image = "MagneticRushMod.png",
			InternalName = "/Lotus/Interface/Cards/Images/Melee/MagneticAttackSpeedMeleeMod",
			Introduced = "38",
			CodexSecret = false,
			Link = "Magnetic Rush",
			MaxRank = 3,
		...
		["Magnetic Strafe"] = {
			...
			Conclave = false,
			Description = "+60% <DT_MAGNETIC_COLOR>Magnetic\r\n+40% Fire Rate",
			Icon = "MagneticStrafe.jpg",
			Image = "MagneticStrafeMod.png",
			InternalName = "/Lotus/Language/Upgrades/MagneticFireRateShotgunMod",
			Introduced = "38",
			Link = "Magnetic Strafe",
			MaxRank = 3,
		...
		["Magnetic Strike"] = {
			...
			Icon = "MagneticStrike.jpg",
			Image = "MagneticStrikeMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/BeastMagneticImpactMod",
			Introduced = "37",
			Link = "Magnetic Strike",
			MaxRank = 3,
		...
		["Magnetic Welt"] = {
			...
			Icon = "MagneticWelt.jpg",
			Image = "MagneticWeltMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/WeaponMagneticOnImpactShotgunMod",
			Introduced = "38",
			Link = "Magnetic Welt",
			MaxRank = 5,
			Name = "Magnetic Welt",
		...
		["Magnetized Core"] = {
			...
			Conclave = false,
			Description = "+60% <DT_MAGNETIC_COLOR>Magnetic\r\n+40% Critical Damage",
			Icon = "MagnetizedCore.jpg",
			Image = "MagnetizedCoreMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Archwing/Melee/ArchwingEventMagneticCritDamageMeleeMod",
			Introduced = "38",
			Link = "Magnetized Core",
			MaxRank = 3,
		...
		["Magnetized Cycle"] = {
			...
			Conclave = false,
			Description = "+60% <DT_MAGNETIC_COLOR>Magnetic\r\n+30% Fire Rate",
			Icon = "MagnetizedCycle.jpg",
			Image = "MagnetizedCycleMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Archwing/Rifle/ArchwingEventMagneticFireRateRifleMod",
			Introduced = "38",
			Link = "Magnetized Cycle",
			MaxRank = 3,
		...
		["Mecha Overdrive"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "+60% Primary Weapon Status Chance added to Companion\r\n+90% Status Duration",
		...
		["Melee Elementalist"] = {
			...
			Incompatible = { "Galvanized Elementalist" },
		...
		["Melee Prowess"] = {
			...
			Incompatible = { "Flawed Melee Prowess" },
		...
		["Merciless Gunfight"] = {
			...
			Icon = "MercilessGunfight.jpg",
			Image = "MercilessGunfightMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Pistol/DualStat/CriticalDamagePunchThroughMod",
			Introduced = "38",
			Link = "Merciless Gunfight",
			MaxRank = 5,
		...
		["Metal Auger"] = {
			...
			Incompatible = { "Flawed Metal Auger", "Amalgam Argonak Metal Auger" },
		...
		["Metem-Erun"] = {
			...
			Icon = "Metem-Erun.jpg",
			Image = "Metem-ErunMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/SuperSpeedSchools",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Metem-Erun",
			MaxRank = 5,
		...
		["Metem-Hakh"] = {
			...
			Icon = "Metem-Hakh.jpg",
			Image = "Metem-HakhMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/HealthAndShieldSchools",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Metem-Hakh",
			MaxRank = 5,
		...
		Mischief = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "Smeeta Kavat becomes invisible for 9s every 7s while a decoy kavat draws fire. Decoy has a 15% chance to evade damage and blinds nearby enemies on death.",
			Icon = "Mischief.png",
		...
		Mobilize = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "+20% to Parkour Velocity\r\n+20% Aim Glide/Wall Latch Duration",
			Icon = "Mobilize.png",
		...
		["Necrophagic Vigor"] = {
			...
			Icon = "NecrophagicVigor.jpg",
			Image = "NecrophagicVigorMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Event/Nightwave/NightwaveHemaAugmentMod",
			Introduced = "40.0.4",
			Link = "Necrophagic Vigor",
			MaxRank = 5,
		...
		["Negation Armor"] = {
			BaseDrain = 6,
			Description = "Scarab Shell Augment: When Inaros takes fatal damage, he consumes Scarab Shell to heal with a brief invulnerability that ends with a deadly <DT_SLASH_COLOR>Slash Status Effect. Cooldown 30s.",
		...
		["Neutron Star"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Null Star Augment: Particles deal 240 <DT_FIRE_COLOR>Heat Damage with guaranteed Status effect in 8m. On recast, remaining particles seek out enemies with doubled search radius.",
		...
		["Omikuji's Fortune"] = {
			...
			Icon = "Omikuji'sFortune.jpg",
			Image = "Omikuji'sFortuneMod.png",
			InternalName = "/Lotus/Powersuits/Koumei/KoumeiFortuneAugmentCard",
			Introduced = "38.5",
			IsAbilityAugment = true,
			Link = "Omikuji's Fortune",
			MaxRank = 3,
		...
		["Omn-Evi"] = {
			...
			Class = "Naramon",
			Conclave = false,
			Description = "+60% Amp Critical Chance\r\n+10% Amp Critical Damage for each <ZENURIK_CLEAN>Zenurik School Mod",
			Icon = "Omn-Evi.jpg",
			Image = "Omn-EviMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/CritChanceSchool",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Omn-Evi",
			MaxRank = 5,
		...
		["Pacifying Bolts"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Psychic Bolts Augment: Throw an additional 3 force bolts with guaranteed <DT_RADIATION_COLOR>Radiation Status Effect. Enemies struck are confused for 10s.",
		...
		["Pain Points"] = {
			...
			Icon = "PainPoints.jpg",
			Image = "PainPointsMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Nightwave/NightwaveTnJetTurbinePistolAugmentMod",
			Introduced = "38.6",
			IsWeaponAugment = true,
			Link = "Pain Points",
			MaxRank = 5,
		...
		["Peculiar Audience"] = {
			...
			Incompatible = { "Peculiar Growth", "Peculiar Bloom", "Peculiar End" },
		...
		["Peculiar Bloom"] = {
			...
			Incompatible = { "Peculiar Audience", "Peculiar Growth", "Peculiar End" },
		...
		["Peculiar End"] = {
			...
			Icon = "PeculiarEnd.jpg",
			Image = "PeculiarEndMod.png",
			Incompatible = { "Peculiar Audience", "Peculiar Growth", "Peculiar Bloom" },
			InternalName = "/Lotus/Upgrades/CosmeticEnhancers/Peculiars/DissolveEnemyMod",
			Introduced = "40.0.5.1",
			IsExilus = true,
			Link = "Peculiar End",
			MaxRank = 5,
		...
		["Peculiar Growth"] = {
			...
			Incompatible = { "Peculiar Audience", "Peculiar Bloom", "Peculiar End" },
		...
		["Persistent Posture"] = {
			...
			Icon = "PersistentPosture.jpg",
			Image = "PersistentPostureMod.png",
			InternalName = "/Lotus/Types/Friendly/Pets/BeastWeapons/Stances/BeastPersistentStance",
			Introduced = "37",
			Link = "Persistent Posture",
			MaxRank = 3,
		...
		["Photon Overcharge"] = {
			BaseDrain = 2,
			Conclave = false,
			Description = "+90% Critical Damage\r\nOn Kill or Assist: Slain enemies have a 2% chance to drop an Energy Orb per <DT_FREEZE_COLOR>Cold Status affecting them.",
		...
		["Piercing Hit"] = {
			...
			Incompatible = { "Flawed Piercing Hit" },
		...
		["Piercing Roar"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Roar Augment: Roar gains +40% range. Enemies within 25m are knocked down and suffer 5 stacks of <DT_PUNCTURE_COLOR>Puncture Status.",
		...
		["Piercing Step"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+18% to Bullet Jump\r\n+18% Aim Glide/Wall Latch Duration\r\n+60% <DT_PUNCTURE_COLOR>Puncture on Bullet Jump",
		...
		["Pistol Acuity"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+350% Weak Point Damage\r\n+350% Weak Point Critical Chance. Multishot cannot be modified.",
			Icon = "PistolAcuity.jpg",
			Image = "PistolAcuityMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Pistol/WeaponWeakpointCriticalChanceMod",
			Introduced = "38",
			Link = "Pistol Acuity",
			MaxRank = 10,
			Name = "Pistol Acuity",
		...
		["Point Strike"] = {
			...
			Incompatible = { "Flawed Point Strike", "Critical Delay" },
		...
		["Power Throw"] = {
			...
			Incompatible = { "Flawed Power Throw" },
		...
		["Precision Conditioning"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+385% Melee Damage\r\nConvert all base Physical Damage to <DT_SLASH_COLOR>Slash Damage",
			Icon = "PrecisionConditioning.jpg",
			Image = "PrecisionConditioningMod.png",
			Incompatible = { "Brute Conditioning", "Disabling Conditioning" },
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/BeastPrecisionConditioningMod",
			Introduced = "37",
			Link = "Precision Conditioning",
			MaxRank = 10,
		...
		["Pressure Point"] = {
			...
			Incompatible = { "Primed Pressure Point", "Sacrificial Pressure", "Amanata Pressure", "Flawed Pressure Point" },
		...
		["Prey of Dynar"] = {
			...
			Icon = "PreyofDynar.jpg",
			Image = "PreyofDynarMod.png",
			InternalName = "/Lotus/Powersuits/Werewolf/WerewolfShroudAugmentCard",
			Introduced = "37",
			IsAbilityAugment = true,
			Link = "Prey of Dynar",
			MaxRank = 3,
		...
		["Primary Acuity"] = {
			...
			Conclave = false,
			Description = "+350% Weak Point Damage\r\n+350% Weak Point Critical Chance. Multishot cannot be modified.",
			Icon = "PrimaryAcuity.jpg",
			Image = "PrimaryAcuityMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Rifle/WeaponWeakpointCriticalChanceMod",
			Introduced = "38",
			Link = "Primary Acuity",
			MaxRank = 10,
			Name = "Primary Acuity",
		...
		["Primed Ammo Chain"] = {
			...
			Incompatible = { "Ammo Chain" },
			InternalName = "/Lotus/Upgrades/Mods/Archwing/Rifle/Expert/ArchwingRifleAmmoMaxModExpert",
			Introduced = "41.1.2",
			CodexSecret = false,
			Link = "Primed Ammo Chain",
			MaxRank = 10,
			Name = "Primed Ammo Chain",
			Icon = "PrimedAmmoChain.png",
			Polarity = "Naramon",
			Rarity = "Legendary",
			Tradable = true,
			Transmutable = false,
		...
		["Primed Bane of Infested"] = {
			...
			Incompatible = { "Bane of Infested", "Flawed Bane of Infested" },
		...
		["Primed Bane of The Murmur"] = {
			...
			Incompatible = { "Bane of The Murmur" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Expert/PrimedWeaponFactionDamageMurmurs",
			Introduced = "39.1.3",
		...
		["Primed Charged Shell"] = {
			BaseDrain = 6,
			CodexSecret = true,
			Description = "+165% <DT_ELECTRICITY_COLOR>Electricity",
			Icon = "ChargedShell.png",
		...
		["Primed Chilling Grasp"] = {
			BaseDrain = 6,
			CodexSecret = true,
			Description = "+165% <DT_FREEZE_COLOR>Cold",
			Icon = "ChillingGrasp.png",
			Image = "PrimedChillingGraspMod.png",
			Incompatible = { "Chilling Grasp", "Flawed Chilling Grasp" },
		...
		["Primed Cleanse Corpus"] = {
			...
			Incompatible = { "Cleanse Corpus", "Flawed Cleanse Corpus" },
		...
		["Primed Cleanse Grineer"] = {
			...
			Incompatible = { "Cleanse Grineer", "Flawed Cleanse Grineer" },
		...
		["Primed Cleanse Infested"] = {
			...
			Incompatible = { "Cleanse Infested", "Flawed Cleanse Infested" },
		...
		["Primed Cleanse The Murmur"] = {
			...
			Incompatible = { "Cleanse The Murmur" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Expert/WeaponShotgunFactionDamageMurmursExpert",
			Introduced = "39.0.7",
		...
		["Primed Convulsion"] = {
			...
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Expert/PrimedWeaponElectricityDamageMod",
			Introduced = "35.0.6",
		...
		["Primed Counterbalance"] = {
			...
			Incompatible = { "Counterbalance" },
			InternalName = "/Lotus/Upgrades/Mods/Shotgun/Expert/WeaponRecoilReductionModExpert",
			Introduced = "38.5.11",
			IsExilus = true,
		...
		["Primed Cryo Rounds"] = {
			...
			Incompatible = { "Cryo Rounds", "Flawed Cryo Rounds" },
		...
		["Primed Expel Infested"] = {
			...
			Incompatible = { "Expel Infested", "Flawed Expel Infested" },
		...
		["Primed Expel The Murmur"] = {
			...
			Incompatible = { "Expel The Murmur" },
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Expert/WeaponPistolFactionDamageMurmursExpert",
			Introduced = "39.0.7",
		...
		["Primed Fever Strike"] = {
			BaseDrain = 6,
			CodexSecret = true,
			Description = "+165% <DT_POISON_COLOR>Toxin",
			Icon = "FeverStrike.png",
		...
		["Primed Fury"] = {
			...
			Incompatible = { "Fury", "Flawed Fury", "Berserker Fury", "Flawed Berserker Fury" },
		...
		["Primed Heated Charge"] = {
			BaseDrain = 6,
			CodexSecret = true,
			Description = "+165% <DT_FIRE_COLOR>Heat",
			Icon = "HeatedCharge.png",
		...
		["Primed Heavy Trauma"] = {
			...
			Incompatible = { "Heavy Trauma", "Flawed Heavy Trauma" },
		...
		["Primed Pressure Point"] = {
			...
			Incompatible = { "Pressure Point", "Sacrificial Pressure", "Amanata Pressure", "Flawed Pressure Point" },
		...
		["Primed Ravage"] = {
			...
			Incompatible = { "Ravage", "Flawed Ravage" },
		...
		["Primed Smite Corpus"] = {
			...
			Incompatible = { "Smite Corpus", "Flawed Smite Corpus" },
		...
		["Primed Smite Orokin"] = {
			...
			CodexSecret = true,
			Description = "x1.55 Damage to Orokin",
			Icon = "SmiteOrokin.png",
			Image = "PrimedSmiteOrokinMod.png",
			Incompatible = { "Smite Orokin" },
		...
		["Primed Smite Infested"] = {
			...
			Incompatible = { "Smite Infested", "Flawed Smite Infested" },
		...
		["Primed Smite The Murmur"] = {
			...
			Incompatible = { "Smite The Murmur" },
			InternalName = "/Lotus/Upgrades/Mods/Melee/Expert/WeaponMeleeFactionDamageMurmursExpert",
			Introduced = "39.0.2",
		...
		["Primed Stabilizer"] = {
			...
			InternalName = "/Lotus/Upgrades/Mods/Rifle/Expert/WeaponRecoilReductionModExpert",
			Introduced = "38.5.11",
			IsExilus = true,
		...
		["Primed Steady Hands"] = {
			...
			Incompatible = { "Steady Hands" },
			InternalName = "/Lotus/Upgrades/Mods/Pistol/WeaponRecoilReductionModExpert",
			Introduced = "38.5.7",
			IsExilus = true,
		...
		["Primed Streamline"] = {
			...
			Icon = "Streamline.png",
			Image = "PrimedStreamlineMod.png",
			Incompatible = { "Streamline", "Flawed Streamline" },
			InternalName = "/Lotus/Upgrades/Mods/Warframe/Expert/AvatarAbilityEfficiencyModExpert",
			Introduced = "TBA",
			Link = "Primed Streamline",
			MaxRank = 14,
		...
		["Prismatic Companion"] = {
			...
			Icon = "PrismaticCompanion.jpg",
			Image = "PrismaticCompanionMod.png",
			InternalName = "/Lotus/Powersuits/Geode/GeodeCrystalAugmentCard",
			Introduced = "39",
			IsAbilityAugment = true,
			Link = "Prismatic Companion",
			MaxRank = 3,
		...
		["Prosperous Retriever"] = {
			...
			Icon = "ProsperousRetriever.jpg",
			Image = "ProsperousRetrieverMod.png",
			Incompatible = { "Loyal Retriever", "Resourceful Retriever" },
			InternalName = "/Lotus/Types/Sentinels/SentinelPrecepts/BeastCreditDoublingMod",
			Introduced = "37",
			Link = "Prosperous Retriever",
			MaxRank = 5,
		...
		["Protector Posture"] = {
			...
			Icon = "ProtectorPosture.jpg",
			Image = "ProtectorPostureMod.png",
			InternalName = "/Lotus/Types/Friendly/Pets/BeastWeapons/Stances/BeastProtectorStance",
			Introduced = "37",
			Link = "Protector Posture",
			MaxRank = 3,
		...
		["Proton Snap"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Hold Wall Latch for 2s to gain +100% <DT_POISON_COLOR>Toxin Damage\r\n and +50% Status Chance for 20s.",
			Icon = "ProtonSnap.png",
		...
		["Quick Correct"] = {
			...
			Icon = "QuickCorrect.jpg",
			Image = "QuickCorrectMod.png",
			InternalName = "/Lotus/Upgrades/Mods/DataSpike/Potency/GainAntivirusSmallOnSingleUseMod",
			Introduced = "38.5",
			Link = "Quick Correct",
			MaxRank = 3,
			Name = "Quick Correct",
		...
		["Quick Thinking"] = {
			...
			Incompatible = { "Flawed Quick Thinking" },
		...
		["Radon Claws"] = {
			...
			Description = "+60% <DT_RADIATION_COLOR>Radiation\r\n+80% Critical Damage",
			Icon = "RadonClaws.jpg",
			Image = "RadonClawsMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/DualStat/KubrowRadiationEventMeleeMod",
			Introduced = "38",
			Link = "Radon Claws",
			MaxRank = 3,
			Name = "Radon Claws",
		...
		Ravage = {
			...
			Icon = "Ravage.png",
			Image = "RavageMod.png",
			Incompatible = { "Flawed Ravage", "Primed Ravage" },
		...
		["Ravenous Wraith"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "Stance: When the Death Well fills, Sevagoth's Shadow form is ready to be released. Tear the enemy asunder with a collection of melee-focused abilties.",
		...
		["Razor Mortar"] = {
			...
			Icon = "RazorMortar.jpg",
			Image = "RazorMortarMod.png",
			InternalName = "/Lotus/Powersuits/Sentient/SentientWhirlwindAugmentCard",
			Introduced = "39",
			IsAbilityAugment = true,
			Link = "Razor Mortar",
			MaxRank = 3,
		...
		["Razor Shot"] = {
			...
			Incompatible = { "Flawed Razor Shot" },
		...
		Reflection = {
			...
			Incompatible = { "Flawed Reflection" },
		...
		["Reflex Coil"] = {
			...
			Incompatible = { "Flawed Reflex Coil", "Galvanized Reflex" },
			IncompatibilityTags = { "SENTINEL_WEAPON", "HOUND_WEAPON" },
		...
		["Rending Turn"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+18% to Bullet Jump\r\n+18% Aim Glide/Wall Latch Duration\r\n+60% <DT_SLASH_COLOR>Slash on Bullet Jump",
		...
		["Enduring Bastille"] = {
			...
			Icon = "EnduringBastille.png",
			Image = "EnduringBastilleMod.png",
			InternalName = "/Lotus/Powersuits/Trapper/LevTrapAugmentCard",
			Introduced = "15.6",
			IsAbilityAugment = true,
			Link = "Enduring Bastille",
			MaxRank = 3,
		...
		["Resourceful Retriever"] = {
			...
			Icon = "ResourcefulRetriever.jpg",
			Image = "ResourcefulRetrieverMod.png",
			Incompatible = { "Loyal Retriever", "Prosperous Retriever" },
			InternalName = "/Lotus/Types/Sentinels/SentinelPrecepts/BeastResourceDoublingMod",
			Introduced = "37",
			Link = "Resourceful Retriever",
			MaxRank = 5,
		...
		["Reverse Rotorswell"] = {
			...
			Icon = "ReverseRotorswell.jpg",
			Image = "ReverseRotorswellMod.png",
			InternalName = "/Lotus/Powersuits/Gyre/GyreOverchargedAugmentCard",
			Introduced = "40",
			IsAbilityAugment = true,
			Link = "Reverse Rotorswell",
			MaxRank = 3,
		...
		["Rifle Aptitude"] = {
			...
			Incompatible = { "Flawed Rifle Aptitude", "Galvanized Aptitude" },
		...
		["Sacrificial Pressure"] = {
			...
			Incompatible = { "Pressure Point", "Primed Pressure Point", "Amanata Pressure", "Flawed Pressure Point" },
		...
		["Sacrificial Steel"] = {
			...
			Incompatible = { "True Steel", "Galvanized Steel", "Amalgam Ripkas True Steel", "Flawed True Steel" },
			IncompatibilityTags = { "HOUND_WEAPON" },
		...
		["Sawtooth Clip"] = {
			...
			Incompatible = { "Flawed Sawtooth Clip" },
		...
		["Scattered Justice"] = {
			...
			IncompatibilityTags = { "SYNDICATEMODBLOCKED" },
		...
		["Seeking Force"] = {
			...
			Incompatible = { "Flawed Seeking Force" },
		...
		["Self Destruct"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "Explodes when incapacitated, dealing 600 <DT_EXPLOSION_COLOR>Blast Damage in a 18m radius and knocking down nearby enemies.",
		...
		["Semi-Rifle Cannonade"] = {
			...
			IncompatibilityTags = { "MODULAR_GUN" },
		...
		["Sepsis Claws"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+330% <DT_POISON_COLOR>Toxin\r\n+330% Status Chance\r\nConverts all elemental damage from these claws to <DT_POISON_COLOR>Toxin damage",
			Icon = "SepsisClaws.jpg",
			Image = "SepsisClawsMod.png",
			Incompatible = { "Burning Claws", "Chilling Claws", "Shocking Claws" },
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/KubrowToxicConversionMod",
			Introduced = "37",
			Link = "Sepsis Claws",
			MaxRank = 10,
			Name = "Sepsis Claws",
		...
		Serration = {
			...
			Incompatible = { "Amalgam Serration", "Higasa Serration", "Flawed Serration", "Spectral Serration" },
		...
		["Shattered Lash"] = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "Stance: Lash out with stream of shattered glass, or hold for an arcing strike. Stats are boosted by the equipped mods on Shattered Lash.",
			Icon = "ShatteredLashModx256.png",
			Image = "ShatteredLashStanceMod.png",
			InternalName = "/Lotus/Weapons/Tenno/Melee/MeleeTrees/GaraShankMeleeTree",
			Introduced = "38.5",
			Link = "Shattered Lash (Stance)",
			MaxRank = 3,
			Name = "Shattered Lash",
			NotUpgradable = true,
			Polarity = "Zenurik",
		...
		["Shattering Impact"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "<DT_IMPACT_COLOR>Impact Damage reduces enemy Armor by 6.",
		...
		["Shocking Speed"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Speed Augment: While moving under the effects of Speed, enemies within 3m will take 300 <DT_ELECTRICITY_COLOR>Electricity Damage with guaranteed Status effect.",
		...
		["Shocking Claws"] = {
			...
			CodexSecret = false,
			Conclave = false,
			Description = "+330% <DT_ELECTRICITY_COLOR>Electricity\r\n+330% Status Chance\r\nConverts all elemental damage from these claws to <DT_ELECTRICITY_COLOR>Electricity damage",
			Icon = "ShockingClaws.jpg",
			Image = "ShockingClawsMod.png",
			Incompatible = { "Burning Claws", "Chilling Claws", "Sepsis Claws" },
			InternalName = "/Lotus/Upgrades/Mods/Sentinel/Kubrow/BeastWeapon/KubrowElectricConversionMod",
			Introduced = "37",
			Link = "Shocking Claws",
			MaxRank = 10,
			Name = "Shocking Claws",
		...
		["Sey-Taph"] = {
			...
			Icon = "Sey-Taph.jpg",
			Image = "Sey-TaphMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/VoidSlingEfficiency",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Sey-Taph",
			MaxRank = 5,
		...
		["Shotgun Savvy"] = {
			...
			Incompatible = { "Flawed Shotgun Savvy", "Galvanized Savvy" },
		...
		["Sil-Tabol"] = {
			...
			Class = "Madurai",
			Conclave = false,
			Description = "+60% Amp Status Chance\r\n+15% Status Damage for each <VAZARIN_CLEAN>Vazarin School Mod",
			Icon = "Sil-Tabol.jpg",
			Image = "Sil-TabolMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/ProcChanceSchool",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Sil-Tabol",
			MaxRank = 5,
		...
		["Smite Corpus"] = {
			...
			Incompatible = { "Flawed Smite Corpus", "Primed Smite Corpus" },
		...
		["Smite Orokin"] = {
			...
			Description = "x1.3 Damage to Orokin",
			Icon = "SmiteOrokin.png",
			Image = "SmiteOrokinMod.png",
			Incompatible = { "Primed Smite Orokin" },
		...
		["Smite Grineer"] = {
			...
			Incompatible = { "Flawed Smite Grineer", "Primed Smite Grineer" },
		...
		["Smite Infested"] = {
			...
			Incompatible = { "Flawed Smite Infested", "Primed Smite Infested" },
		...
		["Smite The Murmur"] = {
			...
			Incompatible = { "Primed Smite The Murmur" },
		...
		["Soft Safe"] = {
			...
			Icon = "SoftSafe.png",
			Image = "SoftSafeMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Immortal/AntivirusSixMod",
			Introduced = "38.5",
			Link = "Soft Safe",
			MaxRank = 3,
			Name = "Soft Safe",
		...
		["Spectral Serration"] = {
			...
			Icon = "SpectralSerration.jpg",
			Image = "SpectralSerrationMod.png",
			Incompatible = { "Amalgam Serration", "Higasa Serration", "Flawed Serration", "Serration" },
			InternalName = "/Lotus/Upgrades/Mods/Rifle/WeaponDamageAmountInvisibleMod",
			Introduced = "38",
			Link = "Spectral Serration",
			MaxRank = 10,
		...
		["Split Chamber"] = {
			...
			Incompatible = { "Flawed Split Chamber", "Split Flights", "Galvanized Chamber" },
		...
		["Split Flights"] = {
			...
			Incompatible = { "Split Chamber", "Flawed Split Chamber", "Galvanized Chamber" },
		...
		["Spontaneous Singularity"] = {
			...
			Icon = "SpontaneousSingularity.jpg",
			Image = "SpontaneousSingularityMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Nightwave/NightwaveCephPrimaryAugmentMod",
			Introduced = "38.6",
			IsWeaponAugment = true,
			Link = "Spontaneous Singularity",
			MaxRank = 5,
		...
		Stabilizer = {
			...
			Incompatible = { "Primed Stabilizer" },
		...
		["Steady Hands"] = {
			...
			Incompatible = { "Primed Steady Hands" },
		...
		["Summoner's Wrath"] = {
			...
			Icon = "Summoner'sWrath.png",
			Image = "Summoner'sWrathMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Aura/PlayerCompanionSummonDamageAuraMod",
			Introduced = "38",
			Link = "Summoner's Wrath",
			MaxRank = 5,
		...
		["Sundering Strike"] = {
			...
			Incompatible = { "Flawed Sundering Strike" },
		...
		["Sure Shot"] = {
			...
			Incompatible = { "Flawed Sure Shot", "Galvanized Shot" },
		...
		["Survival Instinct"] = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "On Bullet Jump:\r\nEnemies lose sight of you for 1.5s. 5s cooldown.",
		...
		["Swing Line"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Rip Line Augment: Rip Lines has no Energy cost while Airborne.\r\n+20% Parkour Velocity",
			Icon = "SwingLine.png",
		...
		["Talsek-An"] = {
			...
			Icon = "Talsek-An.jpg",
			Image = "Talsek-AnMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/EnterVoidModeOnKnockdown",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Talsek-An",
			MaxRank = 5,
		...
		["Tesla Bank"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Tesla Nervos Augment: Enemy health when a Nervos is first attached is converted into a 8m burst of <DT_ELECTRICITY_COLOR>Electricity when killed.",
			Icon = "TeslaBank.png",
		...
		["Tharros Lethality"] = {
			...
			Image = "TharrosLethalityMod.png",
			InternalName = "/Lotus/Powersuits/Hoplite/HopliteBashAugmentCard",
			Introduced = "40",
			CodexSecret = false,
			IsAbilityAugment = true,
			Link = "Tharros Lethality",
			MaxRank = 3,
			Name = "Tharros Lethality",
			Icon = "TharrosLethality.jpg",
			Polarity = "Zenurik",
			Rarity = "Rare",
			Tradable = true,
			Transmutable = false,
		...
		["Threat Blocker"] = {
			...
			Icon = "ThreatBlocker.jpg",
			Image = "ThreatBlockerMod.png",
			InternalName = "/Lotus/Upgrades/Mods/DataSpike/Potency/GainAntivirusAndWeaponDamageOnUseMod",
			Introduced = "38.5",
			Link = "Threat Blocker",
			MaxRank = 3,
			Name = "Threat Blocker",
		...
		["Toxic Blight"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "+100% <DT_POISON_COLOR>Toxin\r\n+1 'Blight'",
		...
		["Toxic Flight"] = {
			BaseDrain = 2,
			CodexSecret = false,
			Description = "+24.2% to Bullet Jump\r\n+24.2% Aim Glide/Wall Latch Duration\r\n+275% <DT_POISON_COLOR>Toxin on Bullet Jump",
		...
		["Toxin Resistance"] = {
			BaseDrain = -2,
			CodexSecret = false,
			Description = "+15% <DT_POISON_COLOR>Toxin Resistance",
		...
		["Trojan Tracker"] = {
			...
			Icon = "TrojanTracker.png",
			Image = "TrojanTrackerMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Immortal/AntivirusThreeMod",
			Introduced = "38.5",
			Link = "Trojan Tracker",
			MaxRank = 3,
			Name = "Trojan Tracker",
		...
		["True Steel"] = {
			...
			Incompatible = { "Galvanized Steel", "Sacrificial Steel", "Amalgam Ripkas True Steel", "Flawed True Steel" },
		...
		["Truth's Flame"] = {
			BaseDrain = 4,
			CodexSecret = false,
			Description = "Enables Tennokai. Successfull Tennokai kills grant an additional 4s Tennokai opportunity with +120% Melee Damage bonus. Be warned, failing to kill a target with a Tennokai attack will self-inflict 100 <DT_FIRE_COLOR>Heat Damage/s and reset the Combo Counter. +1 'Truth'",
			Icon = "UnidentifiedItem.png",
			Image = "UnidentifiedItem.png",
			InternalName = "TBA",
			Introduced = "TBA",
			IsExilus = true,
			Link = "Truth's Flame",
		...
		["Turbo Protect"] = {
			...
			Icon = "TurboProtect.jpg",
			Image = "TurboProtectMod.png",
			InternalName = "/Lotus/Upgrades/Mods/DataSpike/Potency/GainAntivirusAndSpeedOnUseMod",
			Introduced = "38.5",
			Link = "Turbo Protect",
			MaxRank = 3,
			Name = "Turbo Protect",
		...
		["Ubri-Kaneph"] = {
			...
			Icon = "Ubri-Kaneph.jpg",
			Image = "Ubri-KanephMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/WeaponDamageSchools",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Ubri-Kaneph",
			MaxRank = 5,
		...
		["Ulashta-Shol"] = {
			...
			Icon = "Ulashta-Shol.jpg",
			Image = "Ulashta-SholMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/ReduceDeathEffect",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Ulashta-Shol",
			MaxRank = 3,
		...
		["Ulfrun's Endurance"] = {
			BaseDrain = 6,
			Description = "Ulfrun's Descent Augment: During Ulfrun's attack, enemies that die from <DT_SLASH_COLOR>Slash Status within 20m restore Voruna's charges.",
		...
		["Unseen Dread"] = {
			...
			Icon = "UnseenDread.jpg",
			Image = "UnseenDreadMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Bows/Event/Nightwave/NightwaveStalkerBowAugmentMod",
			Introduced = "36.1.5",
			IsWeaponAugment = true,
			Link = "Unseen Dread",
			MaxRank = 5,
		...
		["Untime Rift"] = {
			...
			Icon = "UntimeRift.jpg",
			Image = "UntimeRiftMod.png",
			InternalName = "/Lotus/Powersuits/BrokenFrame/BrokenDestructAugmentCard",
			Introduced = "40",
			IsAbilityAugment = true,
			Link = "Untime Rift",
			MaxRank = 3,
		...
		["Venomous Clip"] = {
			...
			Incompatible = { "Primed Venomous Clip" },
		...
		["Vexing Retaliation"] = {
			...
			CodexSecret = false,
			Conclave = true,
			Description = "Vex Armor Augment: Taking 150 Damage will trigger a 9m burst. Shield damage will cause a <DT_PUNCTURE_COLOR>Puncture Status effect while Health damage will cause a <DT_EXPLOSION_COLOR>Blast Status effect.",
		...
		["Vikla-Safor"] = {
			...
			Class = "Madurai",
			Conclave = false,
			Description = "+30% Amp Fire Rate\r\n+30% Amp Ammo Efficiency",
			Icon = "Vikla-Safor.jpg",
			Image = "Vikla-SaforMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/FireRateAndEfficiency",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Vikla-Safor",
			MaxRank = 5,
		...
		["Vik-Anam"] = {
			...
			Class = "Zenurik",
			Conclave = false,
			Description = "+30% Maximum Amp Energy\r\n+5% Amp Energy Regen Rate for each <MADURAI_CLEAN>Madurai School Mod",
			Icon = "Vik-Anam.jpg",
			Image = "Vik-AnamMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/AmmoSchool",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Vik-Anam",
			MaxRank = 5,
		...
		["Viral Quills"] = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "Launches 6 quills at enemies within 20m, each dealing 60 <DT_VIRAL_COLOR>Viral Damage with 40% Status Chance. If the target is affected by a Viral Status, a Spore is added. 4s cooldown.",
		...
		["Vital Sense"] = {
			...
			Incompatible = { "Flawed Vital Sense" },
		...
		["Volatile Parasite"] = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "Every 15s spits out a maggot that latches onto the nearest enemy, drawing fire from those within 40m. On death, the maggot bursts, dealing 100% of accumulated damage <DT_VIRAL_COLOR>Viral Damage (+40% damage if the enemy dies while latched) to those within 10m.",
		...
		["Volatile Recompense"] = {
			...
			Icon = "VolatileRecompense.jpg",
			Image = "VolatileRecompenseMod.png",
			InternalName = "/Lotus/Powersuits/PaxDuviricus/PaxBladesAugmentCard",
			Introduced = "39",
			IsAbilityAugment = true,
			Link = "Volatile Recompense",
			MaxRank = 3,
		...
		["Warm Coat"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "+12% Shield Resistance to Environmental Ice Hazards",
			Icon = "WarmCoat.png",
		...
		Whipclaw = {
			BaseDrain = 0,
			CodexSecret = false,
			Description = "Stance: Send enemies reeling with a deafening whipcrack. Stats are boosted by the equipped mods on Whipclaw.",
			Icon = "WhipclawModx256.png",
			Image = "WhipclawStanceMod.png",
			InternalName = "/Lotus/Weapons/Tenno/Melee/MeleeTrees/KhoraWhipclawMeleeTree",
			Introduced = "38.5",
			Link = "Whipclaw (Stance)",
			MaxRank = 3,
			Name = "Whipclaw",
			NotUpgradable = true,
			Polarity = "Zenurik",
		...
		["Worm Away"] = {
			...
			Icon = "WormAway.png",
			Image = "WormAwayMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Immortal/AntivirusTwoMod",
			Introduced = "38.5",
			Link = "Worm Away",
			MaxRank = 3,
			Name = "Worm Away",
		...
		["Worthy Comradery"] = {
			...
			Icon = "WorthyComradery.png",
			Image = "WorthyComraderyMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Aura/PlayerWeakpointCriticalChanceAuraMod",
			Introduced = "38",
			Link = "Worthy Comradery",
			MaxRank = 5,
		...
		["Yar Dal"] = {
			...
			Icon = "YarDal.jpg",
			Image = "YarDalMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Antiques/HealthMax",
			--Incompatible = { "" },
			Introduced = "41",
			Link = "Yar Dal",
			MaxRank = 5,
