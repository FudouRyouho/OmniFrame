...
describe('Población/RNG — residuos gated', () => {
	...
	it.todo('generalización a stack-debuff (mismo generador, distinto consumidor) — el gate por la brecha del decay escalar se levantó con #10; falta el consumidor');
});
