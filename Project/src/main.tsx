...
import { BrowserAdapter } from "./shared/data/adapters/BrowserAdapter";
...
// Vía el puerto "0" con BrowserAdapter inyectado (fetch lazy desde /data/): los JSON ya
// NO viajan en el bundle (OQ-DATA-12). El render se difiere hasta que la carga resuelva.
loadEngineData(new BrowserAdapter()).then(() => {
