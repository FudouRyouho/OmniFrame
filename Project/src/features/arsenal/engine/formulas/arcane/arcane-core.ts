 ...
 *   - Arcane Grace     (entidad: warframe) -> AVATAR_HEALTH_MAX plano por stack
 *   - Arcane Guardian  (entidad: warframe) -> AVATAR_ARMOR_MAX plano por stack
 *   - Arcane Energize  (entidad: warframe) -> requiere activacion on-energy-pickup -> fuera de v1
 *   - Arcane Velocity  (entidad: secondary) -> WEAPON_FIRE_RATE flat on-crit -> fuera de v1 (condicional)
 *
 ...
 *   - Docs/features/builder-engine/gaps.md (arcanes.json sin datos estructurados: "no en v1")
 *
 * Estado actual:
