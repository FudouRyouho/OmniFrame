/**
 * OptionsView — Vista de configuración general.
 *
 * Accesible desde DialogMenu → "Options".
 * Contiene:
 *   - Selector de tema/paleta (ThemeSelector.tsx)
 *   - Selector de idioma (locale switching — DT-2)
