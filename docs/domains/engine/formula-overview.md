...
### Notas Operativas
Estas fórmulas representan el núcleo estable del cálculo matemático. La lógica de **cuándo** se activan estas fórmulas (condiciones, triggers) es responsabilidad del **MutatorBridge** y el `SimulationContext` inyectado en cada ejecución.
