...
| [`naming-conventions.md`](naming-conventions.md) | **Casing** de identificadores/archivos por boundary (PascalCase/camelCase/snake…). Distinto de `nomenclature-grammar.md` (gramática de tags) | Antes de nombrar archivos, funciones o tipos |
...
| [`doc-map.md`](doc-map.md) | Tiers de durabilidad del corpus + criterio de archivado + registro de saneamiento | Antes de archivar, reducir o reorganizar docs |