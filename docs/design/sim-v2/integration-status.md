---
Estado: "activo"
Rol: "Auditoría de integración del motor sim-v2 con el Arsenal"
Version: "v0.0.4"
Impacto_ID: "E-05"
...
| **Bridge (MutatorBridge)** | Activo — traduce `EnsembleIntention` → contratos del engine. Absorbe la lógica que `EnsembleAdapter` (eliminado) tenía como stub. | Archon Shards migrados a `EnsembleIntention` (OQ-STATE-2 ✅). DNA mutation parcialmente implementado — ver `simulation-architecture.md §Capa B`. |
