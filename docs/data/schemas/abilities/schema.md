...
`"NONE"` fue un sentinel eliminado en D-11 (2026-05-21). La semántica correcta es ausencia del campo.
...
El campo `upgrade_by` se omite. Su ausencia es el contrato para "valor fijo" — el motor no aplica ningún multiplicador. `"NONE"` fue eliminado en D-11 (2026-05-22).
