...
- `../schemas/abilities/schema.md`
- `../schemas/abilities/workflow.md`
- `../schemas/weapons/source-model.md`
- fuentes de juego y/o captura manual para warframes recientes

## Desbloquea a

- `../../domains/engine/status.md` para soporte trazable de habilidades
- `../../domains/integration/README.md` para migraciones futuras de hidratacion
