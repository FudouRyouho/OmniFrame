...
- Fire 4-round bursts and gain <DT_BLAST> Status

**Notas:**
- Burst count is increased to 4 and shots have guaranteed <DT_BLAST> proc. Damage, Critical Multiplier, and Status Chance are increased, but Critical Chance is reduced.
...
- On Consecutive Weakpoint Hits: Increase Base Damage by **+5**. Stacks up to **3x**.
...
**Efectos:**
- Increase Base Damage by +**X**.
- On Firing: **+5%** Multishot. Stacks up to **10x**.
...
**Notas:**
- The multishot bonus is additive to other sources of multishot such as Split Chamber.
...
**Notas:**
- Sybaris Prime gains **+23%** Status Chance in Incarnon form, rather than the expected **+16%**.
...
- Increase Status Chance by +**Y**.

| Variante | Valor |
|----------|-------|
| Sybaris | X = 5% / Y = 10% |
| Dex Sybaris | X = 5% / Y = 10% |
| Sybaris Prime | X = 5% / Y = 10% |
