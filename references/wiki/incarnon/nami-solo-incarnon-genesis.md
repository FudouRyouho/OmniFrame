...
- On Equip: **+30%** Attack Speed for **4s**.
...
**Efectos:**
- Increase Base Damage by **+80**.
- On Finisher Kill: **+40** Health per second for **10s**.
...
**Notas:**
- Follow Through bonus requires manually equipping the melee, either by holding the weapon swap key (default ) or going into a mission with only the melee weapon equipped.
- Follow Through bonus does not affect quickswap melee attacks.
...
**Challenge:** Perform **40** Finisher Attacks with Melee Weapon equipped
