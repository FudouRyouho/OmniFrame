...
- Create a <DT_COLD> Blast Radius with Heavy Slams.
- **+100%** Melee Damage
...
**Notas:**
- Heavy slams create a slowing field over the radius of the slam for **4** seconds.
...
- **10** additional Combo on targets affected by <DT_COLD> Status.
...
**Efectos:**
- Increase Base Damage by **+20**.
- With Armor Over **450**: Increase Base Damage by **+40**.
...
**Challenge:** Kill **30** <DT_LIFTED> enemies
