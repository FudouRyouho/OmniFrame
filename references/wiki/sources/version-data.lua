local Versions = {
	...
	{
		Name = "Hotfix 42.0.7.1",
		Link = "Update 42#Hotfix 42.0.7.1",
		Aliases = { "42.0.7.1" },
		ShortName = "H42.0.7.1",
		Date = "2026-04-13",
		Parent = "42.0",
		ForumLink = "https://forums.warframe.com/topic/1502193-voruna-prime-hotfix-4207-42071/",
		ArchiveLink = "",
		ArchiveDate = "",
		Timestamp = 1776103993,
	},
	{
		Name = "Hotfix 42.0.8",
		Link = "Update 42#Hotfix 42.0.8",
		Aliases = { "42.0.8" },
		ShortName = "H42.0.8",
		Date = "2026-04-27",
		Parent = "42.0",
		ForumLink = "https://forums.warframe.com/topic/1504592-voruna-prime-hotfix-4208/",
		ArchiveLink = "",
		ArchiveDate = "",
		Timestamp = 1777302262,
	},
	{
		Name = "Hotfix 42.0.9",
		Link = "Update 42#Hotfix 42.0.9",
		Aliases = { "42.0.9" },
		ShortName = "H42.0.9",
		Date = "2026-05-04",
		Parent = "42.0",
		ForumLink = "https://forums.warframe.com/topic/1505376-voruna-prime-hotfix-4209/",
		ArchiveLink = "",
		ArchiveDate = "",
		Timestamp = 1777906835,
	},
	{
		Name = "Hotfix 42.0.10",
		Link = "Update 42#Hotfix 42.0.10",
		Aliases = { "42.0.10" },
		ShortName = "H42.0.10",
		Date = "2026-05-06",
		Parent = "42.0",
		ForumLink = "https://forums.warframe.com/topic/1505719-voruna-prime-hotfix-42010/",
		ArchiveLink = "",
		ArchiveDate = "",
		Timestamp = 1778098251,
	},
	{
		Name = "Hotfix 42.0.11",
		Link = "Update 42#Hotfix 42.0.11",
		Aliases = { "42.0.11" },
		ShortName = "H42.0.11",
		Date = "2026-05-14",
		Parent = "42.0",
	...
	{
		Name = "Hotfix 43.0.7",
		Link = "Update 43#Hotfix 43.0.7",
		Aliases = { "43.0.7" },
		ShortName = "H43.0.7",
		Date = "2026-07-11",
		Parent = "43.0",
		ForumLink = "https://forums.warframe.com/topic/1516048-mesa-heirloom-hotfix-4307/",
		ArchiveLink = "",
		ArchiveDate = "",
		Timestamp = 1783780320,
		Subtitle = "Mesa Heirloom"
	},
	{
		Name = "Hotfix 43.0.8",
		Link = "Update 43#Hotfix 43.0.8",
		Aliases = { "43.0.8" },
		ShortName = "H43.0.8",
		Date = "2026-07-13",
		Parent = "43.0",
		ForumLink = "https://forums.warframe.com/topic/1516479-mesa-heirloom-hotfix-4308/",
		ArchiveLink = "",
		ArchiveDate = "",
