...
**Notas:**
- Incarnon form stuns enemies within **10** meters when activated and after performing a Finisher.
- +100% damage is *additive* with other bonus damage sources like Pressure Point.
...
**Efectos:**
- Increase Base Damage by **+X**.
- **+9** Combo Count on undamaged enemies.
